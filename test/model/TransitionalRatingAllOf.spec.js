...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CwmsRadar.TransitionalRatingAllOf();
  });
  ...
  describe('TransitionalRatingAllOf', function() {
    it('should create an instance of TransitionalRatingAllOf', function() {
      ...
      //var instance = new CwmsRadar.TransitionalRatingAllOf();
      //expect(instance).to.be.a(CwmsRadar.TransitionalRatingAllOf);
    });
