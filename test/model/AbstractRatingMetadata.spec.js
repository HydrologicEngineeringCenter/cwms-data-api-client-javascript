...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CwmsRadar.AbstractRatingMetadata();
  });
  ...
  describe('AbstractRatingMetadata', function() {
    it('should create an instance of AbstractRatingMetadata', function() {
      ...
      //var instance = new CwmsRadar.AbstractRatingMetadata();
      //expect(instance).to.be.a(CwmsRadar.AbstractRatingMetadata);
    });
