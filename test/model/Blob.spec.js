...
(function(root, factory) {
  ...
  describe('Blob', function() {
    it('should create an instance of Blob', function() {
      ...
      //var instance = new CwmsRadar.Blob();
      //expect(instance).to.be.a(CwmsRadar.Blob);
    });
    ...
    it('should have the property mediaTypeId (base name: "mediaTypeId")', function() {
