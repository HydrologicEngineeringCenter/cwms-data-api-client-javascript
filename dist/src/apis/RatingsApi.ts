...
export class RatingsApi extends runtime.BaseAPI {
    ...
    async deleteCwmsDataRatingsSpecWithRatingIdRaw(requestParameters: DeleteCwmsDataRatingsSpecWithRatingIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.ratingId === null || requestParameters.ratingId === undefined) {
            throw new runtime.RequiredError('ratingId','Required parameter requestParameters.ratingId was null or undefined when calling deleteCwmsDataRatingsSpecWithRatingId.');
        }

        if (requestParameters.office === null || requestParameters.office === undefined) {
            throw new runtime.RequiredError('office','Required parameter requestParameters.office was null or undefined when calling deleteCwmsDataRatingsSpecWithRatingId.');
        }

        if (requestParameters.method === null || requestParameters.method === undefined) {
            throw new runtime.RequiredError('method','Required parameter requestParameters.method was null or undefined when calling deleteCwmsDataRatingsSpecWithRatingId.');
        }
        ...
        const response = await this.request({
            path: `/cwms-data/ratings/spec/{rating-id}`.replace(`{${"rating-id"}}`, encodeURIComponent(String(requestParameters.ratingId))),
            method: 'DELETE',
    ...
    async deleteCwmsDataRatingsTemplateWithTemplateIdRaw(requestParameters: DeleteCwmsDataRatingsTemplateWithTemplateIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.templateId === null || requestParameters.templateId === undefined) {
            throw new runtime.RequiredError('templateId','Required parameter requestParameters.templateId was null or undefined when calling deleteCwmsDataRatingsTemplateWithTemplateId.');
        }

        if (requestParameters.office === null || requestParameters.office === undefined) {
            throw new runtime.RequiredError('office','Required parameter requestParameters.office was null or undefined when calling deleteCwmsDataRatingsTemplateWithTemplateId.');
        }

        if (requestParameters.method === null || requestParameters.method === undefined) {
            throw new runtime.RequiredError('method','Required parameter requestParameters.method was null or undefined when calling deleteCwmsDataRatingsTemplateWithTemplateId.');
        }
        ...
        const response = await this.request({
            path: `/cwms-data/ratings/template/{template-id}`.replace(`{${"template-id"}}`, encodeURIComponent(String(requestParameters.templateId))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async deleteCwmsDataRatingsWithRatingIdRaw(requestParameters: DeleteCwmsDataRatingsWithRatingIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.ratingId === null || requestParameters.ratingId === undefined) {
            throw new runtime.RequiredError('ratingId','Required parameter requestParameters.ratingId was null or undefined when calling deleteCwmsDataRatingsWithRatingId.');
        }

        if (requestParameters.office === null || requestParameters.office === undefined) {
            throw new runtime.RequiredError('office','Required parameter requestParameters.office was null or undefined when calling deleteCwmsDataRatingsWithRatingId.');
        }

        if (requestParameters.begin === null || requestParameters.begin === undefined) {
            throw new runtime.RequiredError('begin','Required parameter requestParameters.begin was null or undefined when calling deleteCwmsDataRatingsWithRatingId.');
        }

        if (requestParameters.end === null || requestParameters.end === undefined) {
            throw new runtime.RequiredError('end','Required parameter requestParameters.end was null or undefined when calling deleteCwmsDataRatingsWithRatingId.');
        }
        ...
        const response = await this.request({
            path: `/cwms-data/ratings/{rating-id}`.replace(`{${"rating-id"}}`, encodeURIComponent(String(requestParameters.ratingId))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     */
    async getCwmsDataRatingsMetadataRaw(requestParameters: GetCwmsDataRatingsMetadataRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RatingMetadataList>> {
        const queryParameters: any = {};
        ...
        const response = await this.request({
            path: `/cwms-data/ratings/metadata`,
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Get cwmsData ratings metadata
     */
    async getCwmsDataRatingsMetadata(requestParameters: GetCwmsDataRatingsMetadataRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RatingMetadataList> {
        const response = await this.getCwmsDataRatingsMetadataRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async getCwmsDataRatingsSpecWithRatingIdRaw(requestParameters: GetCwmsDataRatingsSpecWithRatingIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RatingSpec>> {
        if (requestParameters.ratingId === null || requestParameters.ratingId === undefined) {
            throw new runtime.RequiredError('ratingId','Required parameter requestParameters.ratingId was null or undefined when calling getCwmsDataRatingsSpecWithRatingId.');
        }

        if (requestParameters.office === null || requestParameters.office === undefined) {
            throw new runtime.RequiredError('office','Required parameter requestParameters.office was null or undefined when calling getCwmsDataRatingsSpecWithRatingId.');
        }
    ...
    async getCwmsDataRatingsTemplateRaw(requestParameters: GetCwmsDataRatingsTemplateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RatingTemplates>> {
        ...
        const response = await this.request({
            path: `/cwms-data/ratings/template`,
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async getCwmsDataRatingsTemplateWithTemplateIdRaw(requestParameters: GetCwmsDataRatingsTemplateWithTemplateIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<RatingTemplate>>> {
        if (requestParameters.templateId === null || requestParameters.templateId === undefined) {
            throw new runtime.RequiredError('templateId','Required parameter requestParameters.templateId was null or undefined when calling getCwmsDataRatingsTemplateWithTemplateId.');
        }

        if (requestParameters.office === null || requestParameters.office === undefined) {
            throw new runtime.RequiredError('office','Required parameter requestParameters.office was null or undefined when calling getCwmsDataRatingsTemplateWithTemplateId.');
        }
    ...
    async getCwmsDataRatingsWithRatingIdRaw(requestParameters: GetCwmsDataRatingsWithRatingIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.ratingId === null || requestParameters.ratingId === undefined) {
            throw new runtime.RequiredError('ratingId','Required parameter requestParameters.ratingId was null or undefined when calling getCwmsDataRatingsWithRatingId.');
        }

        if (requestParameters.office === null || requestParameters.office === undefined) {
            throw new runtime.RequiredError('office','Required parameter requestParameters.office was null or undefined when calling getCwmsDataRatingsWithRatingId.');
        }
    ...
    async patchCwmsDataRatingsWithRatingIdRaw(requestParameters: PatchCwmsDataRatingsWithRatingIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.ratingId === null || requestParameters.ratingId === undefined) {
            throw new runtime.RequiredError('ratingId','Required parameter requestParameters.ratingId was null or undefined when calling patchCwmsDataRatingsWithRatingId.');
        }

        if (requestParameters.body === null || requestParameters.body === undefined) {
            throw new runtime.RequiredError('body','Required parameter requestParameters.body was null or undefined when calling patchCwmsDataRatingsWithRatingId.');
        }
    ...
    async postCwmsDataRatingsRaw(requestParameters: PostCwmsDataRatingsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.body === null || requestParameters.body === undefined) {
            throw new runtime.RequiredError('body','Required parameter requestParameters.body was null or undefined when calling postCwmsDataRatings.');
        }
    ...
    async postCwmsDataRatingsSpecRaw(requestParameters: PostCwmsDataRatingsSpecRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.ratingSpec === null || requestParameters.ratingSpec === undefined) {
            throw new runtime.RequiredError('ratingSpec','Required parameter requestParameters.ratingSpec was null or undefined when calling postCwmsDataRatingsSpec.');
        }
    ...
    async postCwmsDataRatingsTemplateRaw(requestParameters: PostCwmsDataRatingsTemplateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.ratingTemplate === null || requestParameters.ratingTemplate === undefined) {
            throw new runtime.RequiredError('ratingTemplate','Required parameter requestParameters.ratingTemplate was null or undefined when calling postCwmsDataRatingsTemplate.');
        }
