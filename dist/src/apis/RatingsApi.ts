...
export class RatingsApi extends runtime.BaseAPI {
   ...
   */
  async deleteCwmsDataRatingsSpecWithRatingIdRaw(
    requestParameters: DeleteCwmsDataRatingsSpecWithRatingIdRequest,
    ...
    const response = await this.request(
      {
        path: `/cwms-data/ratings/spec/{rating-id}`.replace(
          `{${"rating-id"}}`,
          encodeURIComponent(String(requestParameters["ratingId"]))
        ),
        method: "DELETE",
   ...
   * Delete cwmsData ratings spec with ratingId
   */
  async deleteCwmsDataRatingsSpecWithRatingId(
    requestParameters: DeleteCwmsDataRatingsSpecWithRatingIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.deleteCwmsDataRatingsSpecWithRatingIdRaw(
      requestParameters,
      initOverrides
    );
  }
   ...
   */
  async deleteCwmsDataRatingsTemplateWithTemplateIdRaw(
    requestParameters: DeleteCwmsDataRatingsTemplateWithTemplateIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/cwms-data/ratings/template/{template-id}`.replace(
          `{${"template-id"}}`,
   ...
   * Delete cwmsData ratings template with templateId
   */
  async deleteCwmsDataRatingsTemplateWithTemplateId(
    requestParameters: DeleteCwmsDataRatingsTemplateWithTemplateIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.deleteCwmsDataRatingsTemplateWithTemplateIdRaw(
      requestParameters,
      initOverrides
    );
  }
   ...
   */
  async deleteCwmsDataRatingsWithRatingIdRaw(
    requestParameters: DeleteCwmsDataRatingsWithRatingIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["ratingId"] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/cwms-data/ratings/{rating-id}`.replace(
          `{${"rating-id"}}`,
          encodeURIComponent(String(requestParameters["ratingId"]))
        ),
        method: "DELETE",
   ...
   * Delete cwmsData ratings with ratingId
   */
  async deleteCwmsDataRatingsWithRatingId(
    requestParameters: DeleteCwmsDataRatingsWithRatingIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.deleteCwmsDataRatingsWithRatingIdRaw(
      requestParameters,
      initOverrides
    );
  }
   ...
   */
  async getCwmsDataRatingsRaw(
    requestParameters: GetCwmsDataRatingsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
   ...
   * Get cwmsData ratings
   */
  async getCwmsDataRatings(
    requestParameters: GetCwmsDataRatingsRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<object> {
    const response = await this.getCwmsDataRatingsRaw(
      requestParameters,
      initOverrides
    );
   ...
   */
  async getCwmsDataRatingsMetadataRaw(
    requestParameters: GetCwmsDataRatingsMetadataRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RatingMetadataList>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      RatingMetadataListFromJSON(jsonValue)
    );
  }
   ...
   * Get cwmsData ratings metadata
   */
  async getCwmsDataRatingsMetadata(
    requestParameters: GetCwmsDataRatingsMetadataRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<RatingMetadataList> {
    const response = await this.getCwmsDataRatingsMetadataRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   */
  async getCwmsDataRatingsSpecRaw(
    requestParameters: GetCwmsDataRatingsSpecRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RatingSpecs>> {
    const queryParameters: any = {};
   ...
   * Get cwmsData ratings spec
   */
  async getCwmsDataRatingsSpec(
    requestParameters: GetCwmsDataRatingsSpecRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<RatingSpecs> {
    const response = await this.getCwmsDataRatingsSpecRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   */
  async getCwmsDataRatingsSpecWithRatingIdRaw(
    requestParameters: GetCwmsDataRatingsSpecWithRatingIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RatingSpec>> {
    if (requestParameters["ratingId"] == null) {
      throw new runtime.RequiredError(
        "ratingId",
   ...
   * Get cwmsData ratings spec with ratingId
   */
  async getCwmsDataRatingsSpecWithRatingId(
    requestParameters: GetCwmsDataRatingsSpecWithRatingIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<RatingSpec> {
    const response = await this.getCwmsDataRatingsSpecWithRatingIdRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   */
  async getCwmsDataRatingsTemplateRaw(
    requestParameters: GetCwmsDataRatingsTemplateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RatingTemplates>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      RatingTemplatesFromJSON(jsonValue)
    );
  }
   ...
   * Get cwmsData ratings template
   */
  async getCwmsDataRatingsTemplate(
    requestParameters: GetCwmsDataRatingsTemplateRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<RatingTemplates> {
    const response = await this.getCwmsDataRatingsTemplateRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   */
  async getCwmsDataRatingsTemplateWithTemplateIdRaw(
    requestParameters: GetCwmsDataRatingsTemplateWithTemplateIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<RatingTemplate>>> {
    if (requestParameters["templateId"] == null) {
      throw new runtime.RequiredError(
        "templateId",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(RatingTemplateFromJSON)
    );
  }
   ...
   * Get cwmsData ratings template with templateId
   */
  async getCwmsDataRatingsTemplateWithTemplateId(
    requestParameters: GetCwmsDataRatingsTemplateWithTemplateIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<RatingTemplate>> {
    const response = await this.getCwmsDataRatingsTemplateWithTemplateIdRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   */
  async getCwmsDataRatingsWithRatingIdRaw(
    requestParameters: GetCwmsDataRatingsWithRatingIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<object>> {
    if (requestParameters["ratingId"] == null) {
      throw new runtime.RequiredError(
   ...
   * Get cwmsData ratings with ratingId
   */
  async getCwmsDataRatingsWithRatingId(
    requestParameters: GetCwmsDataRatingsWithRatingIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<object> {
    const response = await this.getCwmsDataRatingsWithRatingIdRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   */
  async patchCwmsDataRatingsWithRatingIdRaw(
    requestParameters: PatchCwmsDataRatingsWithRatingIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["ratingId"] == null) {
      throw new runtime.RequiredError(
   ...
   * Patch cwmsData ratings with ratingId
   */
  async patchCwmsDataRatingsWithRatingId(
    requestParameters: PatchCwmsDataRatingsWithRatingIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.patchCwmsDataRatingsWithRatingIdRaw(
      requestParameters,
      initOverrides
    );
  }
   ...
   */
  async postCwmsDataRatingsRaw(
    requestParameters: PostCwmsDataRatingsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["body"] == null) {
      throw new runtime.RequiredError(
   ...
   */
  async postCwmsDataRatingsSpecRaw(
    requestParameters: PostCwmsDataRatingsSpecRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
   ...
   */
  async postCwmsDataRatingsTemplateRaw(
    requestParameters: PostCwmsDataRatingsTemplateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
   ...
   * Post cwmsData ratings template
   */
  async postCwmsDataRatingsTemplate(
    requestParameters: PostCwmsDataRatingsTemplateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
