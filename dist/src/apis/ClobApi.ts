...
export class ClobApi extends runtime.BaseAPI {
    ...
    async deleteCwmsDataClobsWithClobIdRaw(requestParameters: DeleteCwmsDataClobsWithClobIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.clobId === null || requestParameters.clobId === undefined) {
            throw new runtime.RequiredError('clobId','Required parameter requestParameters.clobId was null or undefined when calling deleteCwmsDataClobsWithClobId.');
        }

        if (requestParameters.office === null || requestParameters.office === undefined) {
            throw new runtime.RequiredError('office','Required parameter requestParameters.office was null or undefined when calling deleteCwmsDataClobsWithClobId.');
        }
        ...
        const response = await this.request({
            path: `/cwms-data/clobs/{clob-id}`.replace(`{${"clob-id"}}`, encodeURIComponent(String(requestParameters.clobId))),
            method: 'DELETE',
    ...
    async getCwmsDataClobsWithClobIdRaw(requestParameters: GetCwmsDataClobsWithClobIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Clob>> {
        if (requestParameters.clobId === null || requestParameters.clobId === undefined) {
            throw new runtime.RequiredError('clobId','Required parameter requestParameters.clobId was null or undefined when calling getCwmsDataClobsWithClobId.');
        }
    ...
    async patchCwmsDataClobsWithClobIdRaw(requestParameters: PatchCwmsDataClobsWithClobIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.clobId === null || requestParameters.clobId === undefined) {
            throw new runtime.RequiredError('clobId','Required parameter requestParameters.clobId was null or undefined when calling patchCwmsDataClobsWithClobId.');
        }

        if (requestParameters.clob === null || requestParameters.clob === undefined) {
            throw new runtime.RequiredError('clob','Required parameter requestParameters.clob was null or undefined when calling patchCwmsDataClobsWithClobId.');
        }
    ...
    async postCwmsDataClobsRaw(requestParameters: PostCwmsDataClobsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.clob === null || requestParameters.clob === undefined) {
            throw new runtime.RequiredError('clob','Required parameter requestParameters.clob was null or undefined when calling postCwmsDataClobs.');
        }
