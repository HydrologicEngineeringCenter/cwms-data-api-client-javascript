...
export class LocationCategoriesApi extends runtime.BaseAPI {
    ...
    async deleteCwmsDataLocationCategoryWithCategoryIdRaw(requestParameters: DeleteCwmsDataLocationCategoryWithCategoryIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.categoryId === null || requestParameters.categoryId === undefined) {
            throw new runtime.RequiredError('categoryId','Required parameter requestParameters.categoryId was null or undefined when calling deleteCwmsDataLocationCategoryWithCategoryId.');
        }

        if (requestParameters.office === null || requestParameters.office === undefined) {
            throw new runtime.RequiredError('office','Required parameter requestParameters.office was null or undefined when calling deleteCwmsDataLocationCategoryWithCategoryId.');
        }
    ...
    async getCwmsDataLocationCategoryWithCategoryIdRaw(requestParameters: GetCwmsDataLocationCategoryWithCategoryIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<LocationCategory>> {
        if (requestParameters.categoryId === null || requestParameters.categoryId === undefined) {
            throw new runtime.RequiredError('categoryId','Required parameter requestParameters.categoryId was null or undefined when calling getCwmsDataLocationCategoryWithCategoryId.');
        }

        if (requestParameters.office === null || requestParameters.office === undefined) {
            throw new runtime.RequiredError('office','Required parameter requestParameters.office was null or undefined when calling getCwmsDataLocationCategoryWithCategoryId.');
        }
    ...
    async postCwmsDataLocationCategoryRaw(requestParameters: PostCwmsDataLocationCategoryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.locationCategory === null || requestParameters.locationCategory === undefined) {
            throw new runtime.RequiredError('locationCategory','Required parameter requestParameters.locationCategory was null or undefined when calling postCwmsDataLocationCategory.');
        }
