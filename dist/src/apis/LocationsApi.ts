...
import type { CdaError, Location } from "../models/index";
import {
  CdaErrorFromJSON,
  CdaErrorToJSON,
  LocationFromJSON,
...
export class LocationsApi extends runtime.BaseAPI {
   ...
   */
  async deleteCwmsDataLocationsWithLocationIdRaw(
    requestParameters: DeleteCwmsDataLocationsWithLocationIdRequest,
    ...
    const response = await this.request(
      {
        path: `/cwms-data/locations/{location-id}`.replace(
          `{${"location-id"}}`,
   ...
   * Delete cwmsData locations with locationId
   */
  async deleteCwmsDataLocationsWithLocationId(
    requestParameters: DeleteCwmsDataLocationsWithLocationIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.deleteCwmsDataLocationsWithLocationIdRaw(
      requestParameters,
      initOverrides
    );
  }
   ...
   */
  async getCwmsDataLocationsRaw(
    requestParameters: GetCwmsDataLocationsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
   ...
   * Get cwmsData locations
   */
  async getCwmsDataLocations(
    requestParameters: GetCwmsDataLocationsRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<object> {
    const response = await this.getCwmsDataLocationsRaw(
      requestParameters,
      initOverrides
    );
   ...
   */
  async getCwmsDataLocationsWithLocationIdRaw(
    requestParameters: GetCwmsDataLocationsWithLocationIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Location>> {
    if (requestParameters["locationId"] == null) {
      throw new runtime.RequiredError(
        "locationId",
   ...
   * Get cwmsData locations with locationId
   */
  async getCwmsDataLocationsWithLocationId(
    requestParameters: GetCwmsDataLocationsWithLocationIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Location> {
    const response = await this.getCwmsDataLocationsWithLocationIdRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   */
  async patchCwmsDataLocationsWithLocationIdRaw(
    requestParameters: PatchCwmsDataLocationsWithLocationIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["locationId"] == null) {
      throw new runtime.RequiredError(
   ...
   * Patch cwmsData locations with locationId
   */
  async patchCwmsDataLocationsWithLocationId(
    requestParameters: PatchCwmsDataLocationsWithLocationIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.patchCwmsDataLocationsWithLocationIdRaw(
      requestParameters,
      initOverrides
    );
  }
   ...
   */
  async postCwmsDataLocationsRaw(
    requestParameters: PostCwmsDataLocationsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["location"] == null) {
      throw new runtime.RequiredError(
