...
import type { Blob, Blobs, CdaError } from "../models/index";
import {
  BlobFromJSON,
  BlobToJSON,
  BlobsFromJSON,
...
export class BlobApi extends runtime.BaseAPI {
   ...
   * Get cwmsData blobs
   */
  async getCwmsDataBlobsRaw(
    requestParameters: GetCwmsDataBlobsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Blobs>> {
   ...
   * Get cwmsData blobs
   */
  async getCwmsDataBlobs(
    requestParameters: GetCwmsDataBlobsRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Blobs> {
    const response = await this.getCwmsDataBlobsRaw(
      requestParameters,
      initOverrides
    );
   ...
   */
  async getCwmsDataBlobsWithBlobIdRaw(
    requestParameters: GetCwmsDataBlobsWithBlobIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
    ...
    const response = await this.request(
      {
        path: `/cwms-data/blobs/{blob-id}`.replace(
          `{${"blob-id"}}`,
   ...
   * Get cwmsData blobs with blobId
   */
  async getCwmsDataBlobsWithBlobId(
    requestParameters: GetCwmsDataBlobsWithBlobIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
   ...
   * Post cwmsData blobs
   */
  async postCwmsDataBlobsRaw(
    requestParameters: PostCwmsDataBlobsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
