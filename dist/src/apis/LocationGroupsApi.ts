...
export class LocationGroupsApi extends runtime.BaseAPI {
    ...
    async deleteCwmsDataLocationGroupWithGroupIdRaw(requestParameters: DeleteCwmsDataLocationGroupWithGroupIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.groupId === null || requestParameters.groupId === undefined) {
            throw new runtime.RequiredError('groupId','Required parameter requestParameters.groupId was null or undefined when calling deleteCwmsDataLocationGroupWithGroupId.');
        }

        if (requestParameters.categoryId === null || requestParameters.categoryId === undefined) {
            throw new runtime.RequiredError('categoryId','Required parameter requestParameters.categoryId was null or undefined when calling deleteCwmsDataLocationGroupWithGroupId.');
        }

        if (requestParameters.office === null || requestParameters.office === undefined) {
            throw new runtime.RequiredError('office','Required parameter requestParameters.office was null or undefined when calling deleteCwmsDataLocationGroupWithGroupId.');
        }
        ...
        const response = await this.request({
            path: `/cwms-data/location/group/{group-id}`.replace(`{${"group-id"}}`, encodeURIComponent(String(requestParameters.groupId))),
            method: 'DELETE',
     ...
     */
    async getCwmsDataLocationGroupRaw(requestParameters: GetCwmsDataLocationGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<LocationGroup>>> {
        const queryParameters: any = {};
     ...
     * Get cwmsData location group
     */
    async getCwmsDataLocationGroup(requestParameters: GetCwmsDataLocationGroupRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<LocationGroup>> {
        const response = await this.getCwmsDataLocationGroupRaw(requestParameters, initOverrides);
     ...
     */
    async getCwmsDataLocationGroupWithGroupIdRaw(requestParameters: GetCwmsDataLocationGroupWithGroupIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<LocationGroup>> {
        if (requestParameters.groupId === null || requestParameters.groupId === undefined) {
            throw new runtime.RequiredError('groupId','Required parameter requestParameters.groupId was null or undefined when calling getCwmsDataLocationGroupWithGroupId.');
        }

        if (requestParameters.office === null || requestParameters.office === undefined) {
            throw new runtime.RequiredError('office','Required parameter requestParameters.office was null or undefined when calling getCwmsDataLocationGroupWithGroupId.');
        }

        if (requestParameters.categoryId === null || requestParameters.categoryId === undefined) {
            throw new runtime.RequiredError('categoryId','Required parameter requestParameters.categoryId was null or undefined when calling getCwmsDataLocationGroupWithGroupId.');
        }
     ...
     * Get cwmsData location group with groupId
     */
    async getCwmsDataLocationGroupWithGroupId(requestParameters: GetCwmsDataLocationGroupWithGroupIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<LocationGroup> {
        const response = await this.getCwmsDataLocationGroupWithGroupIdRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async patchCwmsDataLocationGroupWithGroupIdRaw(requestParameters: PatchCwmsDataLocationGroupWithGroupIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.groupId === null || requestParameters.groupId === undefined) {
            throw new runtime.RequiredError('groupId','Required parameter requestParameters.groupId was null or undefined when calling patchCwmsDataLocationGroupWithGroupId.');
        }

        if (requestParameters.office === null || requestParameters.office === undefined) {
            throw new runtime.RequiredError('office','Required parameter requestParameters.office was null or undefined when calling patchCwmsDataLocationGroupWithGroupId.');
        }

        if (requestParameters.locationGroup === null || requestParameters.locationGroup === undefined) {
            throw new runtime.RequiredError('locationGroup','Required parameter requestParameters.locationGroup was null or undefined when calling patchCwmsDataLocationGroupWithGroupId.');
        }
    ...
    async postCwmsDataLocationGroupRaw(requestParameters: PostCwmsDataLocationGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.locationGroup === null || requestParameters.locationGroup === undefined) {
            throw new runtime.RequiredError('locationGroup','Required parameter requestParameters.locationGroup was null or undefined when calling postCwmsDataLocationGroup.');
        }
