...
export class LevelsApi extends runtime.BaseAPI {
   ...
   */
  async deleteCwmsDataLevelsWithLevelIdRaw(
    requestParameters: DeleteCwmsDataLevelsWithLevelIdRequest,
    ...
    const response = await this.request(
      {
        path: `/cwms-data/levels/{level-id}`.replace(
          `{${"level-id"}}`,
   ...
   * Delete cwmsData levels with levelId
   */
  async deleteCwmsDataLevelsWithLevelId(
    requestParameters: DeleteCwmsDataLevelsWithLevelIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.deleteCwmsDataLevelsWithLevelIdRaw(
      requestParameters,
      initOverrides
    );
  }
   ...
   */
  async deleteCwmsDataSpecifiedLevelsWithSpecifiedLevelIdRaw(
    requestParameters: DeleteCwmsDataSpecifiedLevelsWithSpecifiedLevelIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/cwms-data/specified-levels/{specified-level-id}`.replace(
          `{${"specified-level-id"}}`,
          encodeURIComponent(String(requestParameters["specifiedLevelId"]))
        ),
        method: "DELETE",
        headers: headerParameters,
        query: queryParameters,
   ...
   * Delete cwmsData specifiedLevels with specifiedLevelId
   */
  async deleteCwmsDataSpecifiedLevelsWithSpecifiedLevelId(
    requestParameters: DeleteCwmsDataSpecifiedLevelsWithSpecifiedLevelIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.deleteCwmsDataSpecifiedLevelsWithSpecifiedLevelIdRaw(
      requestParameters,
      initOverrides
    );
  }
   ...
   * Get cwmsData levels
   */
  async getCwmsDataLevelsRaw(
    requestParameters: GetCwmsDataLevelsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
   ...
   * Get cwmsData levels
   */
  async getCwmsDataLevels(
    requestParameters: GetCwmsDataLevelsRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<object> {
    const response = await this.getCwmsDataLevelsRaw(
      requestParameters,
      initOverrides
    );
   ...
   */
  async getCwmsDataLevelsWithLevelIdRaw(
    requestParameters: GetCwmsDataLevelsWithLevelIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<LocationLevel>> {
    if (requestParameters["levelId"] == null) {
      throw new runtime.RequiredError(
        "levelId",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      LocationLevelFromJSON(jsonValue)
    );
  }
   ...
   * Get cwmsData levels with levelId
   */
  async getCwmsDataLevelsWithLevelId(
    requestParameters: GetCwmsDataLevelsWithLevelIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<LocationLevel> {
    const response = await this.getCwmsDataLevelsWithLevelIdRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   */
  async getCwmsDataSpecifiedLevelsRaw(
    requestParameters: GetCwmsDataSpecifiedLevelsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SpecifiedLevel>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SpecifiedLevelFromJSON(jsonValue)
    );
  }
   ...
   * Get cwmsData specifiedLevels
   */
  async getCwmsDataSpecifiedLevels(
    requestParameters: GetCwmsDataSpecifiedLevelsRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SpecifiedLevel> {
    const response = await this.getCwmsDataSpecifiedLevelsRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   */
  async patchCwmsDataLevelsWithLevelIdRaw(
    requestParameters: PatchCwmsDataLevelsWithLevelIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["levelId"] == null) {
      throw new runtime.RequiredError(
   ...
   * Patch cwmsData levels with levelId
   */
  async patchCwmsDataLevelsWithLevelId(
    requestParameters: PatchCwmsDataLevelsWithLevelIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.patchCwmsDataLevelsWithLevelIdRaw(
      requestParameters,
      initOverrides
    );
  }
   ...
   */
  async patchCwmsDataSpecifiedLevelsWithSpecifiedLevelIdRaw(
    requestParameters: PatchCwmsDataSpecifiedLevelsWithSpecifiedLevelIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["specifiedLevelId"] == null) {
      throw new runtime.RequiredError(
    ...
    if (requestParameters["specifiedLevelId2"] != null) {
      queryParameters["specified-level-id"] =
        requestParameters["specifiedLevelId2"];
    }
   ...
   * Patch cwmsData specifiedLevels with specifiedLevelId
   */
  async patchCwmsDataSpecifiedLevelsWithSpecifiedLevelId(
    requestParameters: PatchCwmsDataSpecifiedLevelsWithSpecifiedLevelIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.patchCwmsDataSpecifiedLevelsWithSpecifiedLevelIdRaw(
      requestParameters,
      initOverrides
    );
  }
   ...
   */
  async postCwmsDataLevelsRaw(
    requestParameters: PostCwmsDataLevelsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["locationLevel"] == null) {
      throw new runtime.RequiredError(
   ...
   */
  async postCwmsDataSpecifiedLevelsRaw(
    requestParameters: PostCwmsDataSpecifiedLevelsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
   ...
   * Post cwmsData specifiedLevels
   */
  async postCwmsDataSpecifiedLevels(
    requestParameters: PostCwmsDataSpecifiedLevelsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
