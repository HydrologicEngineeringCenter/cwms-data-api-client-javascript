...
import type { CdaError, TimeSeriesCategory } from "../models/index";
import {
  CdaErrorFromJSON,
  CdaErrorToJSON,
...
export class TimeSeriesCategoriesApi extends runtime.BaseAPI {
   ...
   */
  async deleteCwmsDataTimeseriesCategoryWithCategoryIdRaw(
    requestParameters: DeleteCwmsDataTimeseriesCategoryWithCategoryIdRequest,
    ...
    const response = await this.request(
      {
        path: `/cwms-data/timeseries/category/{category-id}`.replace(
          `{${"category-id"}}`,
   ...
   * Delete cwmsData timeseries category with categoryId
   */
  async deleteCwmsDataTimeseriesCategoryWithCategoryId(
    requestParameters: DeleteCwmsDataTimeseriesCategoryWithCategoryIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.deleteCwmsDataTimeseriesCategoryWithCategoryIdRaw(
      requestParameters,
      initOverrides
    );
  }
   ...
   */
  async getCwmsDataTimeseriesCategoryRaw(
    requestParameters: GetCwmsDataTimeseriesCategoryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<TimeSeriesCategory>>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(TimeSeriesCategoryFromJSON)
    );
  }
   ...
   * Get cwmsData timeseries category
   */
  async getCwmsDataTimeseriesCategory(
    requestParameters: GetCwmsDataTimeseriesCategoryRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<TimeSeriesCategory>> {
    const response = await this.getCwmsDataTimeseriesCategoryRaw(
      requestParameters,
      initOverrides
    );
   ...
   */
  async getCwmsDataTimeseriesCategoryWithCategoryIdRaw(
    requestParameters: GetCwmsDataTimeseriesCategoryWithCategoryIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<TimeSeriesCategory>> {
    if (requestParameters["categoryId"] == null) {
      throw new runtime.RequiredError(
        "categoryId",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      TimeSeriesCategoryFromJSON(jsonValue)
    );
  }
   ...
   * Get cwmsData timeseries category with categoryId
   */
  async getCwmsDataTimeseriesCategoryWithCategoryId(
    requestParameters: GetCwmsDataTimeseriesCategoryWithCategoryIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<TimeSeriesCategory> {
    const response = await this.getCwmsDataTimeseriesCategoryWithCategoryIdRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   */
  async postCwmsDataTimeseriesCategoryRaw(
    requestParameters: PostCwmsDataTimeseriesCategoryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
   ...
   * Post cwmsData timeseries category
   */
  async postCwmsDataTimeseriesCategory(
    requestParameters: PostCwmsDataTimeseriesCategoryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.postCwmsDataTimeseriesCategoryRaw(
      requestParameters,
      initOverrides
    );
  }
