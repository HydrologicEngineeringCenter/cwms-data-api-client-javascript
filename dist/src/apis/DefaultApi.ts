...
export class DefaultApi extends runtime.BaseAPI {
    ...
    async getCwmsDataLevelsWithLevelIdTimeseriesRaw(requestParameters: GetCwmsDataLevelsWithLevelIdTimeseriesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.levelId === null || requestParameters.levelId === undefined) {
            throw new runtime.RequiredError('levelId','Required parameter requestParameters.levelId was null or undefined when calling getCwmsDataLevelsWithLevelIdTimeseries.');
        }
        ...
        const response = await this.request({
            path: `/cwms-data/levels/{level-id}/timeseries`.replace(`{${"level-id"}}`, encodeURIComponent(String(requestParameters.levelId))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async getCwmsDataTimeseriesRecentWithGroupIdRaw(requestParameters: GetCwmsDataTimeseriesRecentWithGroupIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.groupId === null || requestParameters.groupId === undefined) {
            throw new runtime.RequiredError('groupId','Required parameter requestParameters.groupId was null or undefined when calling getCwmsDataTimeseriesRecentWithGroupId.');
        }
        ...
        const response = await this.request({
            path: `/cwms-data/timeseries/recent/{group-id}`.replace(`{${"group-id"}}`, encodeURIComponent(String(requestParameters.groupId))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
