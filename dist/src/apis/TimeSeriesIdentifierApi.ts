...
export class TimeSeriesIdentifierApi extends runtime.BaseAPI {
   ...
   */
  async deleteCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesIdRaw(
    requestParameters: DeleteCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesIdRequest,
    ...
    const response = await this.request(
      {
        path: `/cwms-data/timeseries/identifier-descriptor/{timeseries-id}`.replace(
          `{${"timeseries-id"}}`,
          encodeURIComponent(String(requestParameters["timeseriesId"]))
        ),
        method: "DELETE",
   ...
   * Delete cwmsData timeseries identifierDescriptor with timeseriesId
   */
  async deleteCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesId(
    requestParameters: DeleteCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.deleteCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesIdRaw(
      requestParameters,
      initOverrides
    );
  }
   ...
   */
  async getCwmsDataTimeseriesIdentifierDescriptorRaw(
    requestParameters: GetCwmsDataTimeseriesIdentifierDescriptorRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<TimeSeriesIdentifierDescriptors>> {
    const queryParameters: any = {};
    ...
    if (requestParameters["timeseriesIdRegex"] != null) {
      queryParameters["timeseries-id-regex"] =
        requestParameters["timeseriesIdRegex"];
    }
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      TimeSeriesIdentifierDescriptorsFromJSON(jsonValue)
    );
  }
   ...
   * Get cwmsData timeseries identifierDescriptor
   */
  async getCwmsDataTimeseriesIdentifierDescriptor(
    requestParameters: GetCwmsDataTimeseriesIdentifierDescriptorRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<TimeSeriesIdentifierDescriptors> {
    const response = await this.getCwmsDataTimeseriesIdentifierDescriptorRaw(
      requestParameters,
      initOverrides
    );
   ...
   */
  async getCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesIdRaw(
    requestParameters: GetCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<TimeSeriesIdentifierDescriptor>> {
    if (requestParameters["timeseriesId"] == null) {
      throw new runtime.RequiredError(
        "timeseriesId",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      TimeSeriesIdentifierDescriptorFromJSON(jsonValue)
    );
  }
   ...
   * Get cwmsData timeseries identifierDescriptor with timeseriesId
   */
  async getCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesId(
    requestParameters: GetCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<TimeSeriesIdentifierDescriptor> {
    const response =
      await this.getCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesIdRaw(
        requestParameters,
        initOverrides
      );
    return await response.value();
   ...
   */
  async patchCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesIdRaw(
    requestParameters: PatchCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["timeseriesId"] == null) {
      throw new runtime.RequiredError(
   ...
   * Patch cwmsData timeseries identifierDescriptor with timeseriesId
   */
  async patchCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesId(
    requestParameters: PatchCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.patchCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesIdRaw(
      requestParameters,
      initOverrides
    );
  }
   ...
   */
  async postCwmsDataTimeseriesIdentifierDescriptorRaw(
    requestParameters: PostCwmsDataTimeseriesIdentifierDescriptorRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: TimeSeriesIdentifierDescriptorToJSON(
          requestParameters["timeSeriesIdentifierDescriptor"]
        ),
      },
      initOverrides
    );
   ...
   * Post cwmsData timeseries identifierDescriptor
   */
  async postCwmsDataTimeseriesIdentifierDescriptor(
    requestParameters: PostCwmsDataTimeseriesIdentifierDescriptorRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<void> {
    await this.postCwmsDataTimeseriesIdentifierDescriptorRaw(
      requestParameters,
      initOverrides
    );
  }
