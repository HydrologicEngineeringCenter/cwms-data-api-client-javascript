...
export function TimeseriesCatalogEntryFromJSON(
  json: any
): TimeseriesCatalogEntry {
  return TimeseriesCatalogEntryFromJSONTyped(json, false);
}

export function TimeseriesCatalogEntryFromJSONTyped(
  json: any,
  ...
  return {
    ...
    intervalOffset:
      json["intervalOffset"] == null ? undefined : json["intervalOffset"],
    timeZone: json["timeZone"] == null ? undefined : json["timeZone"],
    extents:
      json["extents"] == null
        ? undefined
        : (json["extents"] as Array<any>).map(TimeSeriesExtentsFromJSON),
  };
}

export function TimeseriesCatalogEntryToJSON(
  value?: TimeseriesCatalogEntry | null
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    extents:
      value["extents"] == null
        ? undefined
        : (value["extents"] as Array<any>).map(TimeSeriesExtentsToJSON),
  };
}
