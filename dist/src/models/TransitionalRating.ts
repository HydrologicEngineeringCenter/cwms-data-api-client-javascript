...
export function TransitionalRatingFromJSONTyped(
  json: any,
  ...
  return {
    ...
    sourceRatings:
      json["source-ratings"] == null ? undefined : json["source-ratings"],
    conditions: json["conditions"] == null ? undefined : json["conditions"],
    evaluations: json["evaluations"] == null ? undefined : json["evaluations"],
  };
}

export function TransitionalRatingToJSON(
  value?: TransitionalRating | null
): any {
  if (value == null) {
    return value;
  }
