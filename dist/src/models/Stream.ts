...
export function StreamFromJSONTyped(
  ...
  return {
    ...
    tributaries:
      json["tributaries"] == null
        ? undefined
        : (json["tributaries"] as Array<any>).map(StreamFromJSON),
    streamReaches:
      json["stream-reaches"] == null
        ? undefined
        : (json["stream-reaches"] as Array<any>).map(StreamReachFromJSON),
    divertingStreamId:
      json["diverting-stream-id"] == null
        ? undefined
        : json["diverting-stream-id"],
    receivingStreamId:
      json["receiving-stream-id"] == null
        ? undefined
        : json["receiving-stream-id"],
    confluenceBank:
      json["confluence-bank"] == null ? undefined : json["confluence-bank"],
    diversionBank:
      json["diversion-bank"] == null ? undefined : json["diversion-bank"],
    streamLength:
      json["stream-length"] == null ? undefined : json["stream-length"],
    confluenceStation:
      json["confluence-station"] == null
        ? undefined
        : json["confluence-station"],
    diversionStation:
      json["diversion-station"] == null ? undefined : json["diversion-station"],
    streamLocations:
      json["stream-locations"] == null
        ? undefined
        : (json["stream-locations"] as Array<any>).map(StreamLocationFromJSON),
    comment: json["comment"] == null ? undefined : json["comment"],
    averageSlope:
      json["average-slope"] == null ? undefined : json["average-slope"],
  };
}
...
export function StreamToJSON(value?: Stream | null): any {
  ...
  return {
    ...
    tributaries:
      value["tributaries"] == null
        ? undefined
        : (value["tributaries"] as Array<any>).map(StreamToJSON),
    "stream-reaches":
      value["streamReaches"] == null
        ? undefined
        : (value["streamReaches"] as Array<any>).map(StreamReachToJSON),
    ...
    "stream-locations":
      value["streamLocations"] == null
        ? undefined
        : (value["streamLocations"] as Array<any>).map(StreamLocationToJSON),
