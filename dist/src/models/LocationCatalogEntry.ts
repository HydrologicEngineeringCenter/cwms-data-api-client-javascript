...
export function LocationCatalogEntryFromJSONTyped(
  json: any,
  ...
  return {
    ...
    publishedLatitude:
      json["publishedLatitude"] == null ? undefined : json["publishedLatitude"],
    publishedLongitude:
      json["publishedLongitude"] == null
        ? undefined
        : json["publishedLongitude"],
    horizontalDatum:
      json["horizontalDatum"] == null ? undefined : json["horizontalDatum"],
    elevation: json["elevation"] == null ? undefined : json["elevation"],
    unit: json["unit"] == null ? undefined : json["unit"],
    verticalDatum:
      json["verticalDatum"] == null ? undefined : json["verticalDatum"],
    nation: json["nation"] == null ? undefined : json["nation"],
    state: json["state"] == null ? undefined : json["state"],
    county: json["county"] == null ? undefined : json["county"],
    boundingOffice:
      json["boundingOffice"] == null ? undefined : json["boundingOffice"],
    mapLabel: json["mapLabel"] == null ? undefined : json["mapLabel"],
    active: json["active"] == null ? undefined : json["active"],
    aliases:
      json["aliases"] == null
        ? undefined
        : (json["aliases"] as Array<any>).map(LocationAliasFromJSON),
  };
}

export function LocationCatalogEntryToJSON(
  value?: LocationCatalogEntry | null
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    aliases:
      value["aliases"] == null
        ? undefined
        : (value["aliases"] as Array<any>).map(LocationAliasToJSON),
  };
}
