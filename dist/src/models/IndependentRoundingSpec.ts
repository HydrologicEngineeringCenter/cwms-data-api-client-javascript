...
export function IndependentRoundingSpecFromJSON(
  json: any
): IndependentRoundingSpec {
  return IndependentRoundingSpecFromJSONTyped(json, false);
}

export function IndependentRoundingSpecFromJSONTyped(
  json: any,
...
export function IndependentRoundingSpecToJSON(
  value?: IndependentRoundingSpec | null
): any {
  if (value == null) {
    return value;
  }
