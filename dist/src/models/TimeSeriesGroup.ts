...
export function TimeSeriesGroupFromJSONTyped(
  json: any,
  ...
  return {
    ...
    timeSeriesCategory:
      json["time-series-category"] == null
        ? undefined
        : TimeSeriesCategoryFromJSON(json["time-series-category"]),
    description: json["description"] == null ? undefined : json["description"],
    sharedAliasId:
      json["shared-alias-id"] == null ? undefined : json["shared-alias-id"],
    sharedRefTsId:
      json["shared-ref-ts-id"] == null ? undefined : json["shared-ref-ts-id"],
    assignedTimeSeries:
      json["assigned-time-series"] == null
        ? undefined
        : (json["assigned-time-series"] as Array<any>).map(
            AssignedTimeSeriesFromJSON
          ),
  };
}
...
export function TimeSeriesGroupToJSON(value?: TimeSeriesGroup | null): any {
  ...
  return {
    ...
    id: value["id"],
    "time-series-category": TimeSeriesCategoryToJSON(
      value["timeSeriesCategory"]
    ),
    description: value["description"],
    "shared-alias-id": value["sharedAliasId"],
    "shared-ref-ts-id": value["sharedRefTsId"],
    "assigned-time-series":
      value["assignedTimeSeries"] == null
        ? undefined
        : (value["assignedTimeSeries"] as Array<any>).map(
            AssignedTimeSeriesToJSON
          ),
  };
}
