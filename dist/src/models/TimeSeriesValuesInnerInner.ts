...
export function TimeSeriesValuesInnerInnerFromJSON(
  json: any
): TimeSeriesValuesInnerInner {
  return TimeSeriesValuesInnerInnerFromJSONTyped(json, false);
}

export function TimeSeriesValuesInnerInnerFromJSONTyped(
  json: any,
  ...
  return {
    ...
    qualityCode:
      json["quality-code"] == null ? undefined : json["quality-code"],
  };
}

export function TimeSeriesValuesInnerInnerToJSON(
  value?: TimeSeriesValuesInnerInner | null
): any {
  if (value == null) {
    return value;
  }
