...
export type LocationLevelParameterTypeIdEnum =
  (typeof LocationLevelParameterTypeIdEnum)[keyof typeof LocationLevelParameterTypeIdEnum];
...
export type LocationLevelInterpolateStringEnum =
  (typeof LocationLevelInterpolateStringEnum)[keyof typeof LocationLevelInterpolateStringEnum];
...
export function LocationLevelFromJSONTyped(
  json: any,
  ...
  return {
    ...
    seasonalTimeSeriesId:
      json["seasonal-time-series-id"] == null
        ? undefined
        : json["seasonal-time-series-id"],
    seasonalValues:
      json["seasonal-values"] == null
        ? undefined
        : (json["seasonal-values"] as Array<any>).map(
            SeasonalValueBeanFromJSON
          ),
    specifiedLevelId:
      json["specified-level-id"] == null
        ? undefined
        : json["specified-level-id"],
    parameterTypeId:
      json["parameter-type-id"] == null ? undefined : json["parameter-type-id"],
    parameterId:
      json["parameter-id"] == null ? undefined : json["parameter-id"],
    constantValue:
      json["constant-value"] == null ? undefined : json["constant-value"],
    levelUnitsId:
      json["level-units-id"] == null ? undefined : json["level-units-id"],
    levelDate:
      json["level-date"] == null ? undefined : new Date(json["level-date"]),
    levelComment:
      json["level-comment"] == null ? undefined : json["level-comment"],
    intervalOrigin:
      json["interval-origin"] == null
        ? undefined
        : new Date(json["interval-origin"]),
    intervalMonths:
      json["interval-months"] == null ? undefined : json["interval-months"],
    intervalMinutes:
      json["interval-minutes"] == null ? undefined : json["interval-minutes"],
    interpolateString:
      json["interpolate-string"] == null
        ? undefined
        : json["interpolate-string"],
    durationId: json["duration-id"] == null ? undefined : json["duration-id"],
    attributeValue:
      json["attribute-value"] == null ? undefined : json["attribute-value"],
    attributeUnitsId:
      json["attribute-units-id"] == null
        ? undefined
        : json["attribute-units-id"],
    attributeParameterTypeId:
      json["attribute-parameter-type-id"] == null
        ? undefined
        : json["attribute-parameter-type-id"],
    attributeParameterId:
      json["attribute-parameter-id"] == null
        ? undefined
        : json["attribute-parameter-id"],
    attributeDurationId:
      json["attribute-duration-id"] == null
        ? undefined
        : json["attribute-duration-id"],
    attributeComment:
      json["attribute-comment"] == null ? undefined : json["attribute-comment"],
  };
}
...
export function LocationLevelToJSON(value?: LocationLevel | null): any {
  ...
  return {
    ...
    "seasonal-values":
      value["seasonalValues"] == null
        ? undefined
        : (value["seasonalValues"] as Array<any>).map(SeasonalValueBeanToJSON),
    ...
    "level-date":
      value["levelDate"] == null ? undefined : value["levelDate"].toISOString(),
    "level-comment": value["levelComment"],
    "interval-origin":
      value["intervalOrigin"] == null
        ? undefined
        : value["intervalOrigin"].toISOString(),
