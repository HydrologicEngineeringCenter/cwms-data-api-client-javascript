 ...
 */
export function instanceOfTimeSeriesIdentifierDescriptors(
  value: object
): boolean {
  return true;
}

export function TimeSeriesIdentifierDescriptorsFromJSON(
  json: any
): TimeSeriesIdentifierDescriptors {
  return TimeSeriesIdentifierDescriptorsFromJSONTyped(json, false);
}

export function TimeSeriesIdentifierDescriptorsFromJSONTyped(
  json: any,
  ...
  return {
    ...
    descriptors:
      json["descriptors"] == null
        ? undefined
        : (json["descriptors"] as Array<any>).map(
            TimeSeriesIdentifierDescriptorFromJSON
          ),
...
export function TimeSeriesIdentifierDescriptorsToJSON(
  value?: TimeSeriesIdentifierDescriptors | null
): any {
  if (value == null) {
    return value;
  }
  return {
    descriptors:
      value["descriptors"] == null
        ? undefined
        : (value["descriptors"] as Array<any>).map(
            TimeSeriesIdentifierDescriptorToJSON
          ),
  };
}
