...
export function LocationLevelsFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocationLevels {
    ...
    return {
        ...
        'levels': !exists(json, 'levels') ? undefined : ((json['levels'] as Array<any>).map(LocationLevelFromJSON)),
...
export function LocationLevelsToJSON(value?: LocationLevels | null): any {
    ...
    return {
        ...
        'levels': value.levels === undefined ? undefined : ((value.levels as Array<any>).map(LocationLevelToJSON)),
    };
}
