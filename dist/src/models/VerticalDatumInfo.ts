...
export function VerticalDatumInfoFromJSONTyped(
  json: any,
  ...
  return {
    ...
    nativeDatum:
      json["native-datum"] == null ? undefined : json["native-datum"],
    elevation: json["elevation"] == null ? undefined : json["elevation"],
    offsets:
      json["offsets"] == null
        ? undefined
        : (json["offsets"] as Array<any>).map(OffsetFromJSON),
  };
}
...
export function VerticalDatumInfoToJSON(value?: VerticalDatumInfo | null): any {
  ...
  return {
    ...
    offsets:
      value["offsets"] == null
        ? undefined
        : (value["offsets"] as Array<any>).map(OffsetToJSON),
  };
}
