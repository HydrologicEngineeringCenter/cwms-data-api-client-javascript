...
import { StreamFromJSON, StreamFromJSONTyped, StreamToJSON } from "./Stream";
...
export function BasinFromJSONTyped(
  json: any,
  ...
  return {
    ...
    primaryStream:
      json["primary-stream"] == null
        ? undefined
        : StreamFromJSON(json["primary-stream"]),
    sortOrder: json["sort-order"] == null ? undefined : json["sort-order"],
    basinArea: json["basin-area"] == null ? undefined : json["basin-area"],
    contributingArea:
      json["contributing-area"] == null ? undefined : json["contributing-area"],
    parentBasinId:
      json["parent-basin-id"] == null ? undefined : json["parent-basin-id"],
  };
}
