 ...
 */
export function instanceOfTimeSeriesIntervalUnitsInnerDuration(
  value: object
): boolean {
  return true;
}

export function TimeSeriesIntervalUnitsInnerDurationFromJSON(
  json: any
): TimeSeriesIntervalUnitsInnerDuration {
  return TimeSeriesIntervalUnitsInnerDurationFromJSONTyped(json, false);
}

export function TimeSeriesIntervalUnitsInnerDurationFromJSONTyped(
  json: any,
...
export function TimeSeriesIntervalUnitsInnerDurationToJSON(
  value?: TimeSeriesIntervalUnitsInnerDuration | null
): any {
  if (value == null) {
    return value;
  }
