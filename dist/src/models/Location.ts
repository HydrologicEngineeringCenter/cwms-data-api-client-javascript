...
export type LocationNationEnum =
  (typeof LocationNationEnum)[keyof typeof LocationNationEnum];
...
export function LocationFromJSONTyped(
  ...
  return {
    ...
    timezoneName:
      json["timezone-name"] == null ? undefined : json["timezone-name"],
    locationType:
      json["location-type"] == null ? undefined : json["location-type"],
    locationKind:
      json["location-kind"] == null ? undefined : json["location-kind"],
    nation: json["nation"] == null ? undefined : json["nation"],
    stateInitial:
      json["state-initial"] == null ? undefined : json["state-initial"],
    countyName: json["county-name"] == null ? undefined : json["county-name"],
    nearestCity:
      json["nearest-city"] == null ? undefined : json["nearest-city"],
    horizontalDatum:
      json["horizontal-datum"] == null ? undefined : json["horizontal-datum"],
    publishedLongitude:
      json["published-longitude"] == null
        ? undefined
        : json["published-longitude"],
    publishedLatitude:
      json["published-latitude"] == null
        ? undefined
        : json["published-latitude"],
    verticalDatum:
      json["vertical-datum"] == null ? undefined : json["vertical-datum"],
    elevation: json["elevation"] == null ? undefined : json["elevation"],
    mapLabel: json["map-label"] == null ? undefined : json["map-label"],
    boundingOfficeId:
      json["bounding-office-id"] == null
        ? undefined
        : json["bounding-office-id"],
  };
}
