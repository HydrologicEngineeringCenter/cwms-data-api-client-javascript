...
export function RatingMetadataFromJSONTyped(
  json: any,
  ...
  return {
    ratingSpec:
      json["rating-spec"] == null
        ? undefined
        : RatingSpecFromJSON(json["rating-spec"]),
    ratings:
      json["ratings"] == null
        ? undefined
        : (json["ratings"] as Array<any>).map(AbstractRatingMetadataFromJSON),
  };
}
...
export function RatingMetadataToJSON(value?: RatingMetadata | null): any {
  ...
  return {
    ...
    ratings:
      value["ratings"] == null
        ? undefined
        : (value["ratings"] as Array<any>).map(AbstractRatingMetadataToJSON),
  };
}
