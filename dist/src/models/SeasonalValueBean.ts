...
export function SeasonalValueBeanFromJSONTyped(
  json: any,
  ...
  return {
    ...
    offsetMonths:
      json["offset-months"] == null ? undefined : json["offset-months"],
    offsetMinutes:
      json["offset-minutes"] == null ? undefined : json["offset-minutes"],
  };
}
