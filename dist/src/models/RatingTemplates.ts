...
export function RatingTemplatesFromJSONTyped(
  json: any,
  ...
  return {
    ...
    templates:
      json["templates"] == null
        ? undefined
        : (json["templates"] as Array<any>).map(RatingTemplateFromJSON),
  ...
  return {
    templates:
      value["templates"] == null
        ? undefined
        : (value["templates"] as Array<any>).map(RatingTemplateToJSON),
  };
}
