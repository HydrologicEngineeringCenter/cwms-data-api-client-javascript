...
export function RatingTemplateFromJSONTyped(
  json: any,
  ...
  return {
    ...
    dependentParameter:
      json["dependent-parameter"] == null
        ? undefined
        : json["dependent-parameter"],
    independentParameterSpecs:
      json["independent-parameter-specs"] == null
        ? undefined
        : (json["independent-parameter-specs"] as Array<any>).map(
            ParameterSpecFromJSON
          ),
...
export function RatingTemplateToJSON(value?: RatingTemplate | null): any {
  ...
  return {
    ...
    "independent-parameter-specs":
      value["independentParameterSpecs"] == null
        ? undefined
        : (value["independentParameterSpecs"] as Array<any>).map(
            ParameterSpecToJSON
          ),
