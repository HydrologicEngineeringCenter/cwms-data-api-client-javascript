...
export function LocationGroupFromJSONTyped(
  json: any,
  ...
  return {
    ...
    locationCategory:
      json["location-category"] == null
        ? undefined
        : LocationCategoryFromJSON(json["location-category"]),
    description: json["description"] == null ? undefined : json["description"],
    sharedLocAliasId:
      json["shared-loc-alias-id"] == null
        ? undefined
        : json["shared-loc-alias-id"],
    sharedRefLocationId:
      json["shared-ref-location-id"] == null
        ? undefined
        : json["shared-ref-location-id"],
    locGroupAttribute:
      json["loc-group-attribute"] == null
        ? undefined
        : json["loc-group-attribute"],
    assignedLocations:
      json["assigned-locations"] == null
        ? undefined
        : (json["assigned-locations"] as Array<any>).map(
            AssignedLocationFromJSON
          ),
  };
}
...
export function LocationGroupToJSON(value?: LocationGroup | null): any {
  ...
  return {
    ...
    "assigned-locations":
      value["assignedLocations"] == null
        ? undefined
        : (value["assignedLocations"] as Array<any>).map(
            AssignedLocationToJSON
          ),
  };
}
