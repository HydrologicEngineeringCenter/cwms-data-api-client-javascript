...
export function TimeSeriesIntervalFromJSONTyped(
  json: any,
...
export function TimeSeriesIntervalToJSON(
  value?: TimeSeriesInterval | null
): any {
  if (value == null) {
    return value;
  }
