...
public class RatingSpecs {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.page, ratingSpecs.page) &&
        Objects.equals(this.total, ratingSpecs.total) &&
        Objects.equals(this.specs, ratingSpecs.specs) &&
        Objects.equals(this.nextPage, ratingSpecs.nextPage) &&
        Objects.equals(this.pageSize, ratingSpecs.pageSize);
  }

  @Override
  public int hashCode() {
    return Objects.hash(page, total, specs, nextPage, pageSize);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to RatingSpecs
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RatingSpecs.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RatingSpecs is not found in the empty JSON string", RatingSpecs.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!RatingSpecs.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RatingSpecs` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("specs") != null && !jsonObj.get("specs").isJsonNull()) {
        ...
        if (jsonArrayspecs != null) {
          ...
          for (int i = 0; i < jsonArrayspecs.size(); i++) {
            RatingSpec.validateJsonObject(jsonArrayspecs.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RatingSpecs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RatingSpecs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RatingSpecs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RatingSpecs.class));

       return (TypeAdapter<T>) new TypeAdapter<RatingSpecs>() {
           @Override
           public void write(JsonWriter out, RatingSpecs value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RatingSpecs read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RatingSpecs given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RatingSpecs
  * @throws IOException if the JSON string is invalid with respect to RatingSpecs
  */
  public static RatingSpecs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RatingSpecs.class);
  }

 /**
  * Convert an instance of RatingSpecs to an JSON string
  *
  * @return JSON string
  */
