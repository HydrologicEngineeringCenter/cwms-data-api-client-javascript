...
public class CsvV1Office {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CsvV1Office
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CsvV1Office.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CsvV1Office is not found in the empty JSON string", CsvV1Office.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CsvV1Office.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CsvV1Office` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CsvV1Office.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CsvV1Office' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CsvV1Office> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CsvV1Office.class));

       return (TypeAdapter<T>) new TypeAdapter<CsvV1Office>() {
           @Override
           public void write(JsonWriter out, CsvV1Office value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CsvV1Office read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CsvV1Office given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CsvV1Office
  * @throws IOException if the JSON string is invalid with respect to CsvV1Office
  */
  public static CsvV1Office fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CsvV1Office.class);
  }

 /**
  * Convert an instance of CsvV1Office to an JSON string
  *
  * @return JSON string
  */
