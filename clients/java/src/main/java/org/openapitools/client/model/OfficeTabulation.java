...
public class OfficeTabulation {
  ...
  * @throws IOException if the JSON Object is invalid with respect to OfficeTabulation
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OfficeTabulation.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OfficeTabulation is not found in the empty JSON string", OfficeTabulation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!OfficeTabulation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OfficeTabulation` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OfficeTabulation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OfficeTabulation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OfficeTabulation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OfficeTabulation.class));

       return (TypeAdapter<T>) new TypeAdapter<OfficeTabulation>() {
           @Override
           public void write(JsonWriter out, OfficeTabulation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OfficeTabulation read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of OfficeTabulation given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OfficeTabulation
  * @throws IOException if the JSON string is invalid with respect to OfficeTabulation
  */
  public static OfficeTabulation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OfficeTabulation.class);
  }

 /**
  * Convert an instance of OfficeTabulation to an JSON string
  *
  * @return JSON string
  */
