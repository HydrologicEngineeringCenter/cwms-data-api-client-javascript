...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://cwms-data.usace.army.mil/cwms-data') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2.5/Javascript'
        };
        ...
        return [
            {
              ...
              'variables': {
                host: {
                    'description': "No description provided",
                    'default_value': "cwms-data.usace.army.mil",
                  },
                basePath: {
                    'description': "No description provided",
                    'default_value': "cwms-data",
                  }
                }
            }
      ];
