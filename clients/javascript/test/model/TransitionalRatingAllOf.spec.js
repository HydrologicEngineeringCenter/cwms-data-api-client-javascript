...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CwmsDataApi.TransitionalRatingAllOf();
  });
  ...
  describe('TransitionalRatingAllOf', function() {
    it('should create an instance of TransitionalRatingAllOf', function() {
      // uncomment below and update the code to test TransitionalRatingAllOf
      //var instance = new CwmsDataApi.TransitionalRatingAllOf();
      //expect(instance).to.be.a(CwmsDataApi.TransitionalRatingAllOf);
    });
