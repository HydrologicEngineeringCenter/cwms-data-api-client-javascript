...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CwmsRadar.OfficeCSV();
  });
  ...
  describe('OfficeCSV', function() {
    it('should create an instance of OfficeCSV', function() {
      // uncomment below and update the code to test OfficeCSV
      //var instance = new CwmsRadar.OfficeCSV();
      //expect(instance).to.be.a(CwmsRadar.OfficeCSV);
    });
