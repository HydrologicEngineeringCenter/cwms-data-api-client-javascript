...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CwmsDataApi.RatingTemplates();
  });
  ...
  describe('RatingTemplates', function() {
    it('should create an instance of RatingTemplates', function() {
      // uncomment below and update the code to test RatingTemplates
      //var instance = new CwmsDataApi.RatingTemplates();
      //expect(instance).to.be.a(CwmsDataApi.RatingTemplates);
    });
