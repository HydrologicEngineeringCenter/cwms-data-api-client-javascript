...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CwmsDataApi.TableRatingAllOf();
  });
  ...
  describe('TableRatingAllOf', function() {
    it('should create an instance of TableRatingAllOf', function() {
      // uncomment below and update the code to test TableRatingAllOf
      //var instance = new CwmsDataApi.TableRatingAllOf();
      //expect(instance).to.be.a(CwmsDataApi.TableRatingAllOf);
    });
