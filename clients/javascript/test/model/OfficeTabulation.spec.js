...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CwmsRadar.OfficeTabulation();
  });
  ...
  describe('OfficeTabulation', function() {
    it('should create an instance of OfficeTabulation', function() {
      // uncomment below and update the code to test OfficeTabulation
      //var instance = new CwmsRadar.OfficeTabulation();
      //expect(instance).to.be.a(CwmsRadar.OfficeTabulation);
    });
