...
(function(root, factory) {
  ...
  describe('Clob', function() {
    it('should create an instance of Clob', function() {
      // uncomment below and update the code to test Clob
      //var instance = new CwmsDataApi.Clob();
      //expect(instance).to.be.a(CwmsDataApi.Clob);
    });
