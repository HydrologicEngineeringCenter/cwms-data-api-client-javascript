...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CwmsDataApi.LocationLevels();
  });
  ...
  describe('LocationLevels', function() {
    it('should create an instance of LocationLevels', function() {
      // uncomment below and update the code to test LocationLevels
      //var instance = new CwmsDataApi.LocationLevels();
      //expect(instance).to.be.a(CwmsDataApi.LocationLevels);
    });
