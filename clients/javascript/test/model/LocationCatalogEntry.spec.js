...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CwmsDataApi.LocationCatalogEntry();
  });
  ...
  describe('LocationCatalogEntry', function() {
    it('should create an instance of LocationCatalogEntry', function() {
      ...
      //var instance = new CwmsDataApi.LocationCatalogEntry();
      //expect(instance).to.be.a(CwmsDataApi.LocationCatalogEntry);
    });
