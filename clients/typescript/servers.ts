...
export const server1 = new ServerConfiguration<{  "host": string,  "basePath": string  }>("https://cwms-data.usace.army.mil/cwms-data", {  "host": "cwms-data.usace.army.mil" , "basePath": "cwms-data"  })
