...
export default class BlobApi {
    ...
    */
     ...
     * @param {Number} [pageSize] Deprecated.  Use page-size instead.
     * @param {Number} [pageSize2] How many entries per page returned. Default 20.
     * @param {String} [like] Posix regular expression describing the blob id's you want
