...
export default class LocationsApi {
    ...
    */
     ...
     * @param {String} locationId 
     * @param {String} office Specifies the office in which Location will be updated
     ...
     */
    patchCwmsDataLocationsWithLocationId(locationId, office, location, callback) {
      ...
      // verify the required parameter 'office' is set
      if (office === undefined || office === null) {
        throw new Error("Missing the required parameter 'office' when calling patchCwmsDataLocationsWithLocationId");
      }
     ...
     * @param {String} office Specifies the office in which Location will be created
     * @param {module:model/Location} location 
     ...
     */
    postCwmsDataLocations(office, location, callback) {
      let postBody = location;
      // verify the required parameter 'office' is set
      if (office === undefined || office === null) {
        throw new Error("Missing the required parameter 'office' when calling postCwmsDataLocations");
      }
      // verify the required parameter 'location' is set
      if (location === undefined || location === null) {
