...
export const server1 = new ServerConfiguration<{  }>("https://waters.usace.army.mil", {  })
export const server2 = new ServerConfiguration<{  }>("https://cwms-data.usace.army.mil", {  })
export const server3 = new ServerConfiguration<{  }>("https://cwms.sec.usace.army.mil", {  })
export const server4 = new ServerConfiguration<{  }>("https://cwms-data.usace.army.mil", {  })
