 ...
 */
export function instanceOfTabV1Office(value) {
    return true;
}
export function TabV1OfficeFromJSON(json) {
    return TabV1OfficeFromJSONTyped(json, false);
}
export function TabV1OfficeFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function TabV1OfficeToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
