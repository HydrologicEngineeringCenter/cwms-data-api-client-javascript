 ...
 */
import { IndependentRoundingSpecFromJSON, IndependentRoundingSpecToJSON, } from './IndependentRoundingSpec';
/**
 * Check if a given object implements the RatingSpec interface.
 */
export function instanceOfRatingSpec(value) {
    if (!('officeId' in value))
        return false;
    return true;
}
export function RatingSpecFromJSON(json) {
    return RatingSpecFromJSONTyped(json, false);
}
export function RatingSpecFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
        ...
        'independentRoundingSpecs': json['independent-rounding-specs'] == null ? undefined : (json['independent-rounding-specs'].map(IndependentRoundingSpecFromJSON)),
...
export function RatingSpecToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
        ...
        'independent-rounding-specs': value['independentRoundingSpecs'] == null ? undefined : (value['independentRoundingSpecs'].map(IndependentRoundingSpecToJSON)),
