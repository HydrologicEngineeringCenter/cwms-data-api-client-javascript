...
export declare class LocationsApi extends runtime.BaseAPI {
     ...
     */
    getCwmsDataLocationsRaw(requestParameters: GetCwmsDataLocationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Location>>>;
    /**
     * Returns CWMS Location Data.  The Catalog end-point is also capable of retrieving lists of locations and can filter on additional fields.
     * Get cwmsData locations
     */
    getCwmsDataLocations(requestParameters?: GetCwmsDataLocationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Location>>;
    /**
