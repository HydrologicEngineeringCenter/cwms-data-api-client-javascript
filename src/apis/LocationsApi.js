...
exports.LocationsApiResponseProcessor = exports.LocationsApiRequestFactory = void 0;
 ...
 * no description
 */
var LocationsApiRequestFactory = /** @class */ (function (_super) {
    __extends(LocationsApiRequestFactory, _super);
    function LocationsApiRequestFactory() {
     ...
     */
    LocationsApiRequestFactory.prototype.deleteCwmsDataLocationsWithLocationId = function (locationId, office, _options) {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (locationId === null || locationId === undefined) {
                            throw new baseapi_1.RequiredError("LocationsApi", "deleteCwmsDataLocationsWithLocationId", "locationId");
                        }
                        localVarPath = '/cwms-data/locations/{location-id}'
     ...
     */
    LocationsApiRequestFactory.prototype.getCwmsDataLocations = function (names, office, unit, datum, format, _options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        localVarPath = '/cwms-data/locations';
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.GET);
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        // Query Params
                        if (names !== undefined) {
                            requestContext.setQueryParam("names", ObjectSerializer_1.ObjectSerializer.serialize(names, "string", ""));
                        }
                        // Query Params
                        if (office !== undefined) {
                            requestContext.setQueryParam("office", ObjectSerializer_1.ObjectSerializer.serialize(office, "string", ""));
     ...
     */
    LocationsApiRequestFactory.prototype.getCwmsDataLocationsWithLocationId = function (locationId, office, unit, _options) {
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        // verify required parameter 'locationId' is not null or undefined
                        if (locationId === null || locationId === undefined) {
                            throw new baseapi_1.RequiredError("LocationsApi", "getCwmsDataLocationsWithLocationId", "locationId");
                        }
                        // verify required parameter 'office' is not null or undefined
                        if (office === null || office === undefined) {
                            throw new baseapi_1.RequiredError("LocationsApi", "getCwmsDataLocationsWithLocationId", "office");
                        }
                        localVarPath = '/cwms-data/locations/{location-id}'
                            .replace('{' + 'location-id' + '}', encodeURIComponent(String(locationId)));
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.GET);
     ...
     * @param location
     */
    LocationsApiRequestFactory.prototype.patchCwmsDataLocationsWithLocationId = function (locationId, location, _options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        // verify required parameter 'locationId' is not null or undefined
                        if (locationId === null || locationId === undefined) {
                            throw new baseapi_1.RequiredError("LocationsApi", "patchCwmsDataLocationsWithLocationId", "locationId");
                        }
                        // verify required parameter 'location' is not null or undefined
                        if (location === null || location === undefined) {
                            throw new baseapi_1.RequiredError("LocationsApi", "patchCwmsDataLocationsWithLocationId", "location");
                        }
                        localVarPath = '/cwms-data/locations/{location-id}'
                            .replace('{' + 'location-id' + '}', encodeURIComponent(String(locationId)));
                        ...
                        serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(location, "Location", ""), contentType);
     ...
     * @param location
     */
    LocationsApiRequestFactory.prototype.postCwmsDataLocations = function (location, _options) {
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        // verify required parameter 'location' is not null or undefined
                        if (location === null || location === undefined) {
                            throw new baseapi_1.RequiredError("LocationsApi", "postCwmsDataLocations", "location");
                        }
                        localVarPath = '/cwms-data/locations';
    ...
    return LocationsApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.LocationsApiRequestFactory = LocationsApiRequestFactory;
var LocationsApiResponseProcessor = /** @class */ (function () {
    function LocationsApiResponseProcessor() {
    }
    /**
     ...
     */
    LocationsApiResponseProcessor.prototype.deleteCwmsDataLocationsWithLocationIdWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_y.label) {
                    ...
                    case 9:
                        body = _t.apply(_s, [_v.apply(_u, [_y.sent(), contentType]),
                            "CdaError", ""]);
                        throw new exception_1.ApiException(response.httpStatusCode, "Based on the combination of inputs provided the location was not found.", body, response.headers);
                    case 10:
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    LocationsApiResponseProcessor.prototype.getCwmsDataLocationsWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    LocationsApiResponseProcessor.prototype.getCwmsDataLocationsWithLocationIdWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, body, _w, _x, _y, _z, body, _0, _1, _2, _3, _4, _5;
            return __generator(this, function (_6) {
                switch (_6.label) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    LocationsApiResponseProcessor.prototype.patchCwmsDataLocationsWithLocationIdWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    LocationsApiResponseProcessor.prototype.postCwmsDataLocationsWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
    ...
    return LocationsApiResponseProcessor;
}());
exports.LocationsApiResponseProcessor = LocationsApiResponseProcessor;
