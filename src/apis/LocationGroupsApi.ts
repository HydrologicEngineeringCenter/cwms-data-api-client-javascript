 ...
 * no description
 */
export class LocationGroupsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async deleteCwmsDataLocationGroupWithGroupId(groupId: string, categoryId: string, office: string, cascadeDelete?: boolean, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'groupId' is not null or undefined
        if (groupId === null || groupId === undefined) {
            throw new RequiredError("LocationGroupsApi", "deleteCwmsDataLocationGroupWithGroupId", "groupId");
        }


        // verify required parameter 'categoryId' is not null or undefined
        if (categoryId === null || categoryId === undefined) {
            throw new RequiredError("LocationGroupsApi", "deleteCwmsDataLocationGroupWithGroupId", "categoryId");
        }


        // verify required parameter 'office' is not null or undefined
        if (office === null || office === undefined) {
            throw new RequiredError("LocationGroupsApi", "deleteCwmsDataLocationGroupWithGroupId", "office");
        }
     ...
     */
    public async getCwmsDataLocationGroup(office?: string, includeAssigned?: boolean, locationCategoryLike?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     */
    public async getCwmsDataLocationGroupWithGroupId(groupId: string, office: string, categoryId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'groupId' is not null or undefined
        if (groupId === null || groupId === undefined) {
            throw new RequiredError("LocationGroupsApi", "getCwmsDataLocationGroupWithGroupId", "groupId");
        }


        // verify required parameter 'office' is not null or undefined
        if (office === null || office === undefined) {
            throw new RequiredError("LocationGroupsApi", "getCwmsDataLocationGroupWithGroupId", "office");
        }


        // verify required parameter 'categoryId' is not null or undefined
        if (categoryId === null || categoryId === undefined) {
            throw new RequiredError("LocationGroupsApi", "getCwmsDataLocationGroupWithGroupId", "categoryId");
        }
     ...
     */
    public async patchCwmsDataLocationGroupWithGroupId(groupId: string, office: string, locationGroup: LocationGroup, replaceAssignedLocs?: boolean, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'groupId' is not null or undefined
        if (groupId === null || groupId === undefined) {
            throw new RequiredError("LocationGroupsApi", "patchCwmsDataLocationGroupWithGroupId", "groupId");
        }


        // verify required parameter 'office' is not null or undefined
        if (office === null || office === undefined) {
            throw new RequiredError("LocationGroupsApi", "patchCwmsDataLocationGroupWithGroupId", "office");
        }


        // verify required parameter 'locationGroup' is not null or undefined
        if (locationGroup === null || locationGroup === undefined) {
            throw new RequiredError("LocationGroupsApi", "patchCwmsDataLocationGroupWithGroupId", "locationGroup");
        }
        ...
        if (replaceAssignedLocs !== undefined) {
            requestContext.setQueryParam("replace-assigned-locs", ObjectSerializer.serialize(replaceAssignedLocs, "boolean", ""));
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(locationGroup, "LocationGroup", ""),
            contentType
        );
     ...
     * @param locationGroup 
     */
    public async postCwmsDataLocationGroup(locationGroup: LocationGroup, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'locationGroup' is not null or undefined
        if (locationGroup === null || locationGroup === undefined) {
            throw new RequiredError("LocationGroupsApi", "postCwmsDataLocationGroup", "locationGroup");
        }
...
export class LocationGroupsApiResponseProcessor {
     ...
     */
     public async deleteCwmsDataLocationGroupWithGroupIdWithHttpInfo(response: ResponseContext): Promise<HttpInfo< void>> {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getCwmsDataLocationGroupWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Array<LocationGroup> >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("500", response.httpStatusCode)) {
            const body: CdaError = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
        ...
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: Array<LocationGroup> = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "Array<LocationGroup>", ""
            ) as Array<LocationGroup>;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getCwmsDataLocationGroupWithGroupIdWithHttpInfo(response: ResponseContext): Promise<HttpInfo<LocationGroup >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("500", response.httpStatusCode)) {
            const body: CdaError = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
        ...
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: LocationGroup = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "LocationGroup", ""
            ) as LocationGroup;
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async patchCwmsDataLocationGroupWithGroupIdWithHttpInfo(response: ResponseContext): Promise<HttpInfo< void>> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("500", response.httpStatusCode)) {
            const body: CdaError = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async postCwmsDataLocationGroupWithHttpInfo(response: ResponseContext): Promise<HttpInfo< void>> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("500", response.httpStatusCode)) {
            const body: CdaError = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
