...
export class AuthorizationApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param apiKey 
     */
    public async deleteCwmsDataAuthKeysWithKeyName(keyName: string, apiKey?: ApiKey, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'keyName' is not null or undefined
        if (keyName === null || keyName === undefined) {
            throw new RequiredError("AuthorizationApi", "deleteCwmsDataAuthKeysWithKeyName", "keyName");
        }
     ...
     */
    public async getCwmsDataAuthKeys(_options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     */
    public async getCwmsDataAuthKeysWithKeyName(keyName: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'keyName' is not null or undefined
        if (keyName === null || keyName === undefined) {
            throw new RequiredError("AuthorizationApi", "getCwmsDataAuthKeysWithKeyName", "keyName");
        }
     ...
     * @param apiKey 
     */
    public async postCwmsDataAuthKeys(apiKey?: ApiKey, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
...
export class AuthorizationApiResponseProcessor {
     ...
     */
     public async deleteCwmsDataAuthKeysWithKeyNameWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ApiKey >> {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getCwmsDataAuthKeysWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Array<ApiKey> >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("500", response.httpStatusCode)) {
            const body: CdaError = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getCwmsDataAuthKeysWithKeyNameWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ApiKey >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("500", response.httpStatusCode)) {
            const body: CdaError = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async postCwmsDataAuthKeysWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ApiKey >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("500", response.httpStatusCode)) {
            const body: CdaError = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
