...
exports.TimeZonesApiResponseProcessor = exports.TimeZonesApiRequestFactory = void 0;
 ...
 * no description
 */
var TimeZonesApiRequestFactory = /** @class */ (function (_super) {
    __extends(TimeZonesApiRequestFactory, _super);
    function TimeZonesApiRequestFactory() {
     ...
     */
    TimeZonesApiRequestFactory.prototype.getCwmsDataTimezones = function (format, _options) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        localVarPath = '/cwms-data/timezones';
    ...
    return TimeZonesApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.TimeZonesApiRequestFactory = TimeZonesApiRequestFactory;
var TimeZonesApiResponseProcessor = /** @class */ (function () {
    function TimeZonesApiResponseProcessor() {
    }
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getCwmsDataTimezones
     * @throws ApiException if the response code was not in [200, 299]
     */
    TimeZonesApiResponseProcessor.prototype.getCwmsDataTimezonesWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_2.label) {
                    ...
                    case 10:
                        ...
                        if ((0, util_1.isCodeInRange)("501", response.httpStatusCode)) {
                            throw new exception_1.ApiException(response.httpStatusCode, "The format requested is not implemented", undefined, response.headers);
                        }
    ...
    return TimeZonesApiResponseProcessor;
}());
exports.TimeZonesApiResponseProcessor = TimeZonesApiResponseProcessor;
