...
exports.TimeSeriesIdentifierApiResponseProcessor = exports.TimeSeriesIdentifierApiRequestFactory = void 0;
 ...
 * no description
 */
var TimeSeriesIdentifierApiRequestFactory = /** @class */ (function (_super) {
    __extends(TimeSeriesIdentifierApiRequestFactory, _super);
    function TimeSeriesIdentifierApiRequestFactory() {
     ...
     */
    TimeSeriesIdentifierApiRequestFactory.prototype.deleteCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesId = function (timeseriesId, office, method, _options) {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (timeseriesId === null || timeseriesId === undefined) {
                            throw new baseapi_1.RequiredError("TimeSeriesIdentifierApi", "deleteCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesId", "timeseriesId");
                        }
                        // verify required parameter 'office' is not null or undefined
                        if (office === null || office === undefined) {
                            throw new baseapi_1.RequiredError("TimeSeriesIdentifierApi", "deleteCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesId", "office");
                        }
                        // verify required parameter 'method' is not null or undefined
                        if (method === null || method === undefined) {
                            throw new baseapi_1.RequiredError("TimeSeriesIdentifierApi", "deleteCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesId", "method");
                        }
                        localVarPath = '/cwms-data/timeseries/identifier-descriptor/{timeseries-id}'
     ...
     */
    TimeSeriesIdentifierApiRequestFactory.prototype.getCwmsDataTimeseriesIdentifierDescriptor = function (office, timeseriesIdRegex, page, pageSize, _options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        localVarPath = '/cwms-data/timeseries/identifier-descriptor';
                        ...
                        if (timeseriesIdRegex !== undefined) {
                            requestContext.setQueryParam("timeseries-id-regex", ObjectSerializer_1.ObjectSerializer.serialize(timeseriesIdRegex, "string", ""));
                        }
                        // Query Params
                        if (page !== undefined) {
     ...
     */
    TimeSeriesIdentifierApiRequestFactory.prototype.getCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesId = function (timeseriesId, office, _options) {
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        // verify required parameter 'timeseriesId' is not null or undefined
                        if (timeseriesId === null || timeseriesId === undefined) {
                            throw new baseapi_1.RequiredError("TimeSeriesIdentifierApi", "getCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesId", "timeseriesId");
                        }
                        // verify required parameter 'office' is not null or undefined
                        if (office === null || office === undefined) {
                            throw new baseapi_1.RequiredError("TimeSeriesIdentifierApi", "getCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesId", "office");
                        }
                        localVarPath = '/cwms-data/timeseries/identifier-descriptor/{timeseries-id}'
                            .replace('{' + 'timeseries-id' + '}', encodeURIComponent(String(timeseriesId)));
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.GET);
     ...
     */
    TimeSeriesIdentifierApiRequestFactory.prototype.patchCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesId = function (timeseriesId, timeseriesId2, office, intervalOffset, snapForward, snapBackward, active, _options) {
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, authMethod, defaultAuth;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        // verify required parameter 'timeseriesId' is not null or undefined
                        if (timeseriesId === null || timeseriesId === undefined) {
                            throw new baseapi_1.RequiredError("TimeSeriesIdentifierApi", "patchCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesId", "timeseriesId");
                        }
                        // verify required parameter 'timeseriesId2' is not null or undefined
                        if (timeseriesId2 === null || timeseriesId2 === undefined) {
                            throw new baseapi_1.RequiredError("TimeSeriesIdentifierApi", "patchCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesId", "timeseriesId2");
                        }
                        // verify required parameter 'office' is not null or undefined
                        if (office === null || office === undefined) {
                            throw new baseapi_1.RequiredError("TimeSeriesIdentifierApi", "patchCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesId", "office");
                        }
                        localVarPath = '/cwms-data/timeseries/identifier-descriptor/{timeseries-id}'
                            .replace('{' + 'timeseries-id' + '}', encodeURIComponent(String(timeseriesId)));
                        ...
                        if (timeseriesId2 !== undefined) {
                            requestContext.setQueryParam("timeseries-id", ObjectSerializer_1.ObjectSerializer.serialize(timeseriesId2, "string", ""));
                        }
                        // Query Params
                        if (office !== undefined) {
                            requestContext.setQueryParam("office", ObjectSerializer_1.ObjectSerializer.serialize(office, "string", ""));
                        ...
                        if (intervalOffset !== undefined) {
                            requestContext.setQueryParam("interval-offset", ObjectSerializer_1.ObjectSerializer.serialize(intervalOffset, "number", "int64"));
                        }
                        // Query Params
                        if (snapForward !== undefined) {
                            requestContext.setQueryParam("snap-forward", ObjectSerializer_1.ObjectSerializer.serialize(snapForward, "number", "int64"));
                        }
                        // Query Params
                        if (snapBackward !== undefined) {
                            requestContext.setQueryParam("snap-backward", ObjectSerializer_1.ObjectSerializer.serialize(snapBackward, "number", "int64"));
                        }
                        // Query Params
                        if (active !== undefined) {
                            requestContext.setQueryParam("active", ObjectSerializer_1.ObjectSerializer.serialize(active, "boolean", ""));
                        }
                        // Apply auth methods
                        authMethod = _config.authMethods["ApiKey"];
                        if (!(authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication)) return [3 /*break*/, 2];
     ...
     */
    TimeSeriesIdentifierApiRequestFactory.prototype.postCwmsDataTimeseriesIdentifierDescriptor = function (timeSeriesIdentifierDescriptor, failIfExists, _options) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (timeSeriesIdentifierDescriptor === null || timeSeriesIdentifierDescriptor === undefined) {
                            throw new baseapi_1.RequiredError("TimeSeriesIdentifierApi", "postCwmsDataTimeseriesIdentifierDescriptor", "timeSeriesIdentifierDescriptor");
                        }
                        localVarPath = '/cwms-data/timeseries/identifier-descriptor';
                        ...
                        serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(timeSeriesIdentifierDescriptor, "TimeSeriesIdentifierDescriptor", ""), contentType);
    ...
    return TimeSeriesIdentifierApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.TimeSeriesIdentifierApiRequestFactory = TimeSeriesIdentifierApiRequestFactory;
var TimeSeriesIdentifierApiResponseProcessor = /** @class */ (function () {
    function TimeSeriesIdentifierApiResponseProcessor() {
    }
    /**
     ...
     */
    TimeSeriesIdentifierApiResponseProcessor.prototype.deleteCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesIdWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    TimeSeriesIdentifierApiResponseProcessor.prototype.getCwmsDataTimeseriesIdentifierDescriptorWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_6.label) {
                    ...
                    case 9:
                        body = _t.apply(_s, [_v.apply(_u, [_6.sent(), contentType]),
                            "CdaError", ""]);
                        throw new exception_1.ApiException(response.httpStatusCode, "Based on the combination of inputs provided the time series identifier descriptors were not found.", body, response.headers);
                    case 10:
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    TimeSeriesIdentifierApiResponseProcessor.prototype.getCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesIdWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, body, _w, _x, _y, _z, body, _0, _1, _2, _3, _4, _5;
            return __generator(this, function (_6) {
                switch (_6.label) {
                    ...
                    case 9:
                        body = _t.apply(_s, [_v.apply(_u, [_6.sent(), contentType]),
                            "CdaError", ""]);
                        throw new exception_1.ApiException(response.httpStatusCode, "Based on the combination of inputs provided the timeseries identifier descriptor was not found.", body, response.headers);
                    case 10:
                        if (!(0, util_1.isCodeInRange)("200", response.httpStatusCode)) return [3 /*break*/, 12];
                        _x = (_w = ObjectSerializer_1.ObjectSerializer).deserialize;
                        _z = (_y = ObjectSerializer_1.ObjectSerializer).parse;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    TimeSeriesIdentifierApiResponseProcessor.prototype.patchCwmsDataTimeseriesIdentifierDescriptorWithTimeseriesIdWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    TimeSeriesIdentifierApiResponseProcessor.prototype.postCwmsDataTimeseriesIdentifierDescriptorWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
    ...
    return TimeSeriesIdentifierApiResponseProcessor;
}());
exports.TimeSeriesIdentifierApiResponseProcessor = TimeSeriesIdentifierApiResponseProcessor;
