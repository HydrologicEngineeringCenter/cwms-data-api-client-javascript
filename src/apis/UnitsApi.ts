 ...
 * no description
 */
export class UnitsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getCwmsDataUnits(format?: string, _options?: Configuration): Promise<RequestContext> {
...
export class UnitsApiResponseProcessor {
     ...
     */
     public async getCwmsDataUnitsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
