 ...
 * no description
 */
var DefaultApiRequestFactory = /** @class */ (function (_super) {
     ...
     * Get cwmsData
     */
    DefaultApiRequestFactory.prototype.getCwmsData = function (_options) {
     ...
     * @param levelId
     */
    DefaultApiRequestFactory.prototype.getCwmsDataLevelsWithLevelIdTimeseries = function (levelId, _options) {
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (levelId === null || levelId === undefined) {
                            throw new baseapi_1.RequiredError("DefaultApi", "getCwmsDataLevelsWithLevelIdTimeseries", "levelId");
                        }
                        localVarPath = '/cwms-data/levels/{level-id}/timeseries'
     ...
     * @param groupId
     */
    DefaultApiRequestFactory.prototype.getCwmsDataTimeseriesRecentWithGroupId = function (groupId, _options) {
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (groupId === null || groupId === undefined) {
                            throw new baseapi_1.RequiredError("DefaultApi", "getCwmsDataTimeseriesRecentWithGroupId", "groupId");
                        }
                        localVarPath = '/cwms-data/timeseries/recent/{group-id}'
...
var DefaultApiResponseProcessor = /** @class */ (function () {
     ...
     */
    DefaultApiResponseProcessor.prototype.getCwmsDataWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getCwmsDataLevelsWithLevelIdTimeseries
     * @throws ApiException if the response code was not in [200, 299]
     */
    DefaultApiResponseProcessor.prototype.getCwmsDataLevelsWithLevelIdTimeseriesWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    DefaultApiResponseProcessor.prototype.getCwmsDataTimeseriesRecentWithGroupIdWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
