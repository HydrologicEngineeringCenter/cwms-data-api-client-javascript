...
exports.TimeSeriesCategoriesApiResponseProcessor = exports.TimeSeriesCategoriesApiRequestFactory = void 0;
 ...
 * no description
 */
var TimeSeriesCategoriesApiRequestFactory = /** @class */ (function (_super) {
    __extends(TimeSeriesCategoriesApiRequestFactory, _super);
    function TimeSeriesCategoriesApiRequestFactory() {
     ...
     */
    TimeSeriesCategoriesApiRequestFactory.prototype.deleteCwmsDataTimeseriesCategoryWithCategoryId = function (categoryId, office, cascadeDelete, _options) {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (categoryId === null || categoryId === undefined) {
                            throw new baseapi_1.RequiredError("TimeSeriesCategoriesApi", "deleteCwmsDataTimeseriesCategoryWithCategoryId", "categoryId");
                        }
                        // verify required parameter 'office' is not null or undefined
                        if (office === null || office === undefined) {
                            throw new baseapi_1.RequiredError("TimeSeriesCategoriesApi", "deleteCwmsDataTimeseriesCategoryWithCategoryId", "office");
                        }
                        localVarPath = '/cwms-data/timeseries/category/{category-id}'
     ...
     */
    TimeSeriesCategoriesApiRequestFactory.prototype.getCwmsDataTimeseriesCategory = function (office, _options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        localVarPath = '/cwms-data/timeseries/category';
     ...
     */
    TimeSeriesCategoriesApiRequestFactory.prototype.getCwmsDataTimeseriesCategoryWithCategoryId = function (categoryId, office, _options) {
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        // verify required parameter 'categoryId' is not null or undefined
                        if (categoryId === null || categoryId === undefined) {
                            throw new baseapi_1.RequiredError("TimeSeriesCategoriesApi", "getCwmsDataTimeseriesCategoryWithCategoryId", "categoryId");
                        }
                        // verify required parameter 'office' is not null or undefined
                        if (office === null || office === undefined) {
                            throw new baseapi_1.RequiredError("TimeSeriesCategoriesApi", "getCwmsDataTimeseriesCategoryWithCategoryId", "office");
                        }
                        localVarPath = '/cwms-data/timeseries/category/{category-id}'
                            .replace('{' + 'category-id' + '}', encodeURIComponent(String(categoryId)));
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.GET);
     ...
     */
    TimeSeriesCategoriesApiRequestFactory.prototype.postCwmsDataTimeseriesCategory = function (timeSeriesCategory, failIfExists, _options) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (timeSeriesCategory === null || timeSeriesCategory === undefined) {
                            throw new baseapi_1.RequiredError("TimeSeriesCategoriesApi", "postCwmsDataTimeseriesCategory", "timeSeriesCategory");
                        }
                        localVarPath = '/cwms-data/timeseries/category';
                        ...
                        serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(timeSeriesCategory, "TimeSeriesCategory", ""), contentType);
    ...
    return TimeSeriesCategoriesApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.TimeSeriesCategoriesApiRequestFactory = TimeSeriesCategoriesApiRequestFactory;
var TimeSeriesCategoriesApiResponseProcessor = /** @class */ (function () {
    function TimeSeriesCategoriesApiResponseProcessor() {
    }
    /**
     ...
     */
    TimeSeriesCategoriesApiResponseProcessor.prototype.deleteCwmsDataTimeseriesCategoryWithCategoryIdWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    TimeSeriesCategoriesApiResponseProcessor.prototype.getCwmsDataTimeseriesCategoryWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_6.label) {
                    ...
                    case 9:
                        body = _t.apply(_s, [_v.apply(_u, [_6.sent(), contentType]),
                            "CdaError", ""]);
                        throw new exception_1.ApiException(response.httpStatusCode, "Based on the combination of inputs provided the categories were not found.", body, response.headers);
                    case 10:
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    TimeSeriesCategoriesApiResponseProcessor.prototype.getCwmsDataTimeseriesCategoryWithCategoryIdWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, body, _w, _x, _y, _z, body, _0, _1, _2, _3, _4, _5;
            return __generator(this, function (_6) {
                switch (_6.label) {
                    ...
                    case 9:
                        body = _t.apply(_s, [_v.apply(_u, [_6.sent(), contentType]),
                            "CdaError", ""]);
                        throw new exception_1.ApiException(response.httpStatusCode, "Based on the combination of inputs provided the timeseries category was not found.", body, response.headers);
                    case 10:
                        if (!(0, util_1.isCodeInRange)("200", response.httpStatusCode)) return [3 /*break*/, 12];
                        _x = (_w = ObjectSerializer_1.ObjectSerializer).deserialize;
                        _z = (_y = ObjectSerializer_1.ObjectSerializer).parse;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    TimeSeriesCategoriesApiResponseProcessor.prototype.postCwmsDataTimeseriesCategoryWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
    ...
    return TimeSeriesCategoriesApiResponseProcessor;
}());
exports.TimeSeriesCategoriesApiResponseProcessor = TimeSeriesCategoriesApiResponseProcessor;
