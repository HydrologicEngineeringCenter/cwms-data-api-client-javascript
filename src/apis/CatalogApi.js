...
exports.CatalogApiResponseProcessor = exports.CatalogApiRequestFactory = void 0;
 ...
 * no description
 */
var CatalogApiRequestFactory = /** @class */ (function (_super) {
    __extends(CatalogApiRequestFactory, _super);
    function CatalogApiRequestFactory() {
     ...
     */
    CatalogApiRequestFactory.prototype.getCwmsDataCatalogWithDataset = function (dataset, page, pageSize, unitSystem, office, like, timeseriesCategoryLike, timeseriesGroupLike, locationCategoryLike, locationGroupLike, boundingOfficeLike, _options) {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (dataset === null || dataset === undefined) {
                            throw new baseapi_1.RequiredError("CatalogApi", "getCwmsDataCatalogWithDataset", "dataset");
                        }
                        localVarPath = '/cwms-data/catalog/{dataset}'
                        ...
                        if (unitSystem !== undefined) {
                            requestContext.setQueryParam("unit-system", ObjectSerializer_1.ObjectSerializer.serialize(unitSystem, "UnitSystem", ""));
                        }
                        // Query Params
                        if (office !== undefined) {
                        ...
                        if (locationGroupLike !== undefined) {
                            requestContext.setQueryParam("location-group-like", ObjectSerializer_1.ObjectSerializer.serialize(locationGroupLike, "string", ""));
                        }
                        // Query Params
                        if (boundingOfficeLike !== undefined) {
                            requestContext.setQueryParam("bounding-office-like", ObjectSerializer_1.ObjectSerializer.serialize(boundingOfficeLike, "string", ""));
                        }
    ...
    return CatalogApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.CatalogApiRequestFactory = CatalogApiRequestFactory;
var CatalogApiResponseProcessor = /** @class */ (function () {
    function CatalogApiResponseProcessor() {
    }
    /**
     ...
     */
    CatalogApiResponseProcessor.prototype.getCwmsDataCatalogWithDatasetWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return CatalogApiResponseProcessor;
}());
exports.CatalogApiResponseProcessor = CatalogApiResponseProcessor;
