 ...
 * no description
 */
export class TimeZonesApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getCwmsDataTimezones(format?: string, _options?: Configuration): Promise<RequestContext> {
...
export class TimeZonesApiResponseProcessor {
     ...
     */
     public async getCwmsDataTimezonesWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
        ...
        if (isCodeInRange("501", response.httpStatusCode)) {
            throw new ApiException<undefined>(response.httpStatusCode, "The format requested is not implemented", undefined, response.headers);
        }
