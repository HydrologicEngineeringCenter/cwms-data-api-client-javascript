...
exports.ParametersApiResponseProcessor = exports.ParametersApiRequestFactory = void 0;
 ...
 * no description
 */
var ParametersApiRequestFactory = /** @class */ (function (_super) {
    __extends(ParametersApiRequestFactory, _super);
    function ParametersApiRequestFactory() {
     ...
     */
    ParametersApiRequestFactory.prototype.getCwmsDataParameters = function (format, _options) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        localVarPath = '/cwms-data/parameters';
    ...
    return ParametersApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.ParametersApiRequestFactory = ParametersApiRequestFactory;
var ParametersApiResponseProcessor = /** @class */ (function () {
    function ParametersApiResponseProcessor() {
    }
    /**
     ...
     */
    ParametersApiResponseProcessor.prototype.getCwmsDataParametersWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return ParametersApiResponseProcessor;
}());
exports.ParametersApiResponseProcessor = ParametersApiResponseProcessor;
