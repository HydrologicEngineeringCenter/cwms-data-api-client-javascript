...
exports.OfficesApiResponseProcessor = exports.OfficesApiRequestFactory = void 0;
 ...
 * no description
 */
var OfficesApiRequestFactory = /** @class */ (function (_super) {
    __extends(OfficesApiRequestFactory, _super);
    function OfficesApiRequestFactory() {
     ...
     */
    OfficesApiRequestFactory.prototype.getCwmsDataOffices = function (format, hasData, _options) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        localVarPath = '/cwms-data/offices';
                        ...
                        if (hasData !== undefined) {
                            requestContext.setQueryParam("has-data", ObjectSerializer_1.ObjectSerializer.serialize(hasData, "boolean", ""));
                        }
     ...
     * @param format (Deprecated in favor of Accept header) Specifies the encoding format of the response. Valid value for the format field for this URI are:  1. tab  2. csv   3. xml  4. json (default)
     */
    OfficesApiRequestFactory.prototype.getCwmsDataOfficesWithOffice = function (office, format, _options) {
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (office === null || office === undefined) {
                            throw new baseapi_1.RequiredError("OfficesApi", "getCwmsDataOfficesWithOffice", "office");
                        }
                        localVarPath = '/cwms-data/offices/{office}'
    ...
    return OfficesApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.OfficesApiRequestFactory = OfficesApiRequestFactory;
var OfficesApiResponseProcessor = /** @class */ (function () {
    function OfficesApiResponseProcessor() {
    }
    /**
     ...
     */
    OfficesApiResponseProcessor.prototype.getCwmsDataOfficesWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    OfficesApiResponseProcessor.prototype.getCwmsDataOfficesWithOfficeWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, body, _w, _x, _y, _z, body, _0, _1, _2, _3, _4, _5;
            return __generator(this, function (_6) {
                switch (_6.label) {
    ...
    return OfficesApiResponseProcessor;
}());
exports.OfficesApiResponseProcessor = OfficesApiResponseProcessor;
