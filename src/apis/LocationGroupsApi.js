...
exports.LocationGroupsApiResponseProcessor = exports.LocationGroupsApiRequestFactory = void 0;
 ...
 * no description
 */
var LocationGroupsApiRequestFactory = /** @class */ (function (_super) {
    __extends(LocationGroupsApiRequestFactory, _super);
    function LocationGroupsApiRequestFactory() {
     ...
     */
    LocationGroupsApiRequestFactory.prototype.deleteCwmsDataLocationGroupWithGroupId = function (groupId, categoryId, office, cascadeDelete, _options) {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (groupId === null || groupId === undefined) {
                            throw new baseapi_1.RequiredError("LocationGroupsApi", "deleteCwmsDataLocationGroupWithGroupId", "groupId");
                        }
                        // verify required parameter 'categoryId' is not null or undefined
                        if (categoryId === null || categoryId === undefined) {
                            throw new baseapi_1.RequiredError("LocationGroupsApi", "deleteCwmsDataLocationGroupWithGroupId", "categoryId");
                        }
                        // verify required parameter 'office' is not null or undefined
                        if (office === null || office === undefined) {
                            throw new baseapi_1.RequiredError("LocationGroupsApi", "deleteCwmsDataLocationGroupWithGroupId", "office");
                        }
                        localVarPath = '/cwms-data/location/group/{group-id}'
     ...
     */
    LocationGroupsApiRequestFactory.prototype.getCwmsDataLocationGroup = function (office, includeAssigned, locationCategoryLike, _options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        localVarPath = '/cwms-data/location/group';
                        ...
                        if (locationCategoryLike !== undefined) {
                            requestContext.setQueryParam("location-category-like", ObjectSerializer_1.ObjectSerializer.serialize(locationCategoryLike, "string", ""));
                        }
                        defaultAuth = ((_a = _options === null || _options === void 0 ? void 0 : _options.authMethods) === null || _a === void 0 ? void 0 : _a.default) || ((_c = (_b = this.configuration) === null || _b === void 0 ? void 0 : _b.authMethods) === null || _c === void 0 ? void 0 : _c.default);
     ...
     */
    LocationGroupsApiRequestFactory.prototype.getCwmsDataLocationGroupWithGroupId = function (groupId, office, categoryId, _options) {
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        // verify required parameter 'groupId' is not null or undefined
                        if (groupId === null || groupId === undefined) {
                            throw new baseapi_1.RequiredError("LocationGroupsApi", "getCwmsDataLocationGroupWithGroupId", "groupId");
                        }
                        // verify required parameter 'office' is not null or undefined
                        if (office === null || office === undefined) {
                            throw new baseapi_1.RequiredError("LocationGroupsApi", "getCwmsDataLocationGroupWithGroupId", "office");
                        }
                        // verify required parameter 'categoryId' is not null or undefined
                        if (categoryId === null || categoryId === undefined) {
                            throw new baseapi_1.RequiredError("LocationGroupsApi", "getCwmsDataLocationGroupWithGroupId", "categoryId");
                        }
                        localVarPath = '/cwms-data/location/group/{group-id}'
                            .replace('{' + 'group-id' + '}', encodeURIComponent(String(groupId)));
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.GET);
     ...
     */
    LocationGroupsApiRequestFactory.prototype.patchCwmsDataLocationGroupWithGroupId = function (groupId, office, locationGroup, replaceAssignedLocs, _options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        // verify required parameter 'groupId' is not null or undefined
                        if (groupId === null || groupId === undefined) {
                            throw new baseapi_1.RequiredError("LocationGroupsApi", "patchCwmsDataLocationGroupWithGroupId", "groupId");
                        }
                        // verify required parameter 'office' is not null or undefined
                        if (office === null || office === undefined) {
                            throw new baseapi_1.RequiredError("LocationGroupsApi", "patchCwmsDataLocationGroupWithGroupId", "office");
                        }
                        // verify required parameter 'locationGroup' is not null or undefined
                        if (locationGroup === null || locationGroup === undefined) {
                            throw new baseapi_1.RequiredError("LocationGroupsApi", "patchCwmsDataLocationGroupWithGroupId", "locationGroup");
                        }
                        localVarPath = '/cwms-data/location/group/{group-id}'
                            .replace('{' + 'group-id' + '}', encodeURIComponent(String(groupId)));
                        ...
                        if (replaceAssignedLocs !== undefined) {
                            requestContext.setQueryParam("replace-assigned-locs", ObjectSerializer_1.ObjectSerializer.serialize(replaceAssignedLocs, "boolean", ""));
                        }
                        // Query Params
                        if (office !== undefined) {
                            requestContext.setQueryParam("office", ObjectSerializer_1.ObjectSerializer.serialize(office, "string", ""));
                        ...
                        serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(locationGroup, "LocationGroup", ""), contentType);
     ...
     * @param locationGroup
     */
    LocationGroupsApiRequestFactory.prototype.postCwmsDataLocationGroup = function (locationGroup, _options) {
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        // verify required parameter 'locationGroup' is not null or undefined
                        if (locationGroup === null || locationGroup === undefined) {
                            throw new baseapi_1.RequiredError("LocationGroupsApi", "postCwmsDataLocationGroup", "locationGroup");
                        }
                        localVarPath = '/cwms-data/location/group';
    ...
    return LocationGroupsApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.LocationGroupsApiRequestFactory = LocationGroupsApiRequestFactory;
var LocationGroupsApiResponseProcessor = /** @class */ (function () {
    function LocationGroupsApiResponseProcessor() {
    }
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     * @params response Response returned by the server for a request to deleteCwmsDataLocationGroupWithGroupId
     * @throws ApiException if the response code was not in [200, 299]
     */
    LocationGroupsApiResponseProcessor.prototype.deleteCwmsDataLocationGroupWithGroupIdWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getCwmsDataLocationGroup
     * @throws ApiException if the response code was not in [200, 299]
     */
    LocationGroupsApiResponseProcessor.prototype.getCwmsDataLocationGroupWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getCwmsDataLocationGroupWithGroupId
     * @throws ApiException if the response code was not in [200, 299]
     */
    LocationGroupsApiResponseProcessor.prototype.getCwmsDataLocationGroupWithGroupIdWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, body, _w, _x, _y, _z, body, _0, _1, _2, _3, _4, _5;
            return __generator(this, function (_6) {
                switch (_6.label) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to patchCwmsDataLocationGroupWithGroupId
     * @throws ApiException if the response code was not in [200, 299]
     */
    LocationGroupsApiResponseProcessor.prototype.patchCwmsDataLocationGroupWithGroupIdWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to postCwmsDataLocationGroup
     * @throws ApiException if the response code was not in [200, 299]
     */
    LocationGroupsApiResponseProcessor.prototype.postCwmsDataLocationGroupWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
    ...
    return LocationGroupsApiResponseProcessor;
}());
exports.LocationGroupsApiResponseProcessor = LocationGroupsApiResponseProcessor;
