...
exports.BasinsApiResponseProcessor = exports.BasinsApiRequestFactory = void 0;
 ...
 * no description
 */
var BasinsApiRequestFactory = /** @class */ (function (_super) {
    __extends(BasinsApiRequestFactory, _super);
    function BasinsApiRequestFactory() {
     ...
     */
    BasinsApiRequestFactory.prototype.getCwmsDataBasins = function (office, unit, _options) {
     ...
     * @param unit Specifies the unit or unit system of the response. Valid values for the unit field are:   1. EN.   Specifies English unit system. Basin values will be in the default English units for their parameters. (This is default if no value is entered)  2. SI.   Specifies the SI unit system. Basin values will be in the default SI units for their parameters.
     */
    BasinsApiRequestFactory.prototype.getCwmsDataBasinsWithBasinId = function (basinId, office, unit, _options) {
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (basinId === null || basinId === undefined) {
                            throw new baseapi_1.RequiredError("BasinsApi", "getCwmsDataBasinsWithBasinId", "basinId");
                        }
                        localVarPath = '/cwms-data/basins/{basin-id}'
    ...
    return BasinsApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.BasinsApiRequestFactory = BasinsApiRequestFactory;
var BasinsApiResponseProcessor = /** @class */ (function () {
    function BasinsApiResponseProcessor() {
    }
    /**
     ...
     */
    BasinsApiResponseProcessor.prototype.getCwmsDataBasinsWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_6.label) {
                    ...
                    case 9:
                        body = _t.apply(_s, [_v.apply(_u, [_6.sent(), contentType]),
                            "CdaError", ""]);
                        throw new exception_1.ApiException(response.httpStatusCode, "The provided combination of parameters did not find a basin.", body, response.headers);
                    case 10:
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    BasinsApiResponseProcessor.prototype.getCwmsDataBasinsWithBasinIdWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, body, _w, _x, _y, _z, body, _0, _1, _2, _3, _4, _5;
            return __generator(this, function (_6) {
                switch (_6.label) {
    ...
    return BasinsApiResponseProcessor;
}());
exports.BasinsApiResponseProcessor = BasinsApiResponseProcessor;
