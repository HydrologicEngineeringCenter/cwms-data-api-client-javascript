 ...
 * no description
 */
var AuthorizationApiRequestFactory = /** @class */ (function (_super) {
    __extends(AuthorizationApiRequestFactory, _super);
    function AuthorizationApiRequestFactory() {
     ...
     * @param apiKey
     */
    AuthorizationApiRequestFactory.prototype.deleteCwmsDataAuthKeysWithKeyName = function (keyName, apiKey, _options) {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (keyName === null || keyName === undefined) {
                            throw new baseapi_1.RequiredError("AuthorizationApi", "deleteCwmsDataAuthKeysWithKeyName", "keyName");
                        }
                        localVarPath = '/cwms-data/auth/keys/{key-name}'
                        ...
                        serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(apiKey, "ApiKey", ""), contentType);
     ...
     */
    AuthorizationApiRequestFactory.prototype.getCwmsDataAuthKeys = function (_options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        localVarPath = '/cwms-data/auth/keys';
     ...
     */
    AuthorizationApiRequestFactory.prototype.getCwmsDataAuthKeysWithKeyName = function (keyName, _options) {
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, authMethod, defaultAuth;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        // verify required parameter 'keyName' is not null or undefined
                        if (keyName === null || keyName === undefined) {
                            throw new baseapi_1.RequiredError("AuthorizationApi", "getCwmsDataAuthKeysWithKeyName", "keyName");
                        }
                        localVarPath = '/cwms-data/auth/keys/{key-name}'
                            .replace('{' + 'key-name' + '}', encodeURIComponent(String(keyName)));
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.GET);
     ...
     * @param apiKey
     */
    AuthorizationApiRequestFactory.prototype.postCwmsDataAuthKeys = function (apiKey, _options) {
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            var _a, _b, _c;
            return __generator(this, function (_d) {
    ...
    return AuthorizationApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.AuthorizationApiRequestFactory = AuthorizationApiRequestFactory;
var AuthorizationApiResponseProcessor = /** @class */ (function () {
    function AuthorizationApiResponseProcessor() {
    }
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     * @params response Response returned by the server for a request to deleteCwmsDataAuthKeysWithKeyName
     * @throws ApiException if the response code was not in [200, 299]
     */
    AuthorizationApiResponseProcessor.prototype.deleteCwmsDataAuthKeysWithKeyNameWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_6) {
                switch (_6.label) {
                    ...
                    case 10:
                        if (!(0, util_1.isCodeInRange)("201", response.httpStatusCode)) return [3 /*break*/, 12];
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getCwmsDataAuthKeys
     * @throws ApiException if the response code was not in [200, 299]
     */
    AuthorizationApiResponseProcessor.prototype.getCwmsDataAuthKeysWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, body, _w, _x, _y, _z, body, _0, _1, _2, _3, _4, _5;
            return __generator(this, function (_6) {
                switch (_6.label) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getCwmsDataAuthKeysWithKeyName
     * @throws ApiException if the response code was not in [200, 299]
     */
    AuthorizationApiResponseProcessor.prototype.getCwmsDataAuthKeysWithKeyNameWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, body, _w, _x, _y, _z, body, _0, _1, _2, _3, _4, _5;
            return __generator(this, function (_6) {
                switch (_6.label) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to postCwmsDataAuthKeys
     * @throws ApiException if the response code was not in [200, 299]
     */
    AuthorizationApiResponseProcessor.prototype.postCwmsDataAuthKeysWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, body, _w, _x, _y, _z, body, _0, _1, _2, _3, _4, _5;
            return __generator(this, function (_6) {
                switch (_6.label) {
    ...
    return AuthorizationApiResponseProcessor;
}());
