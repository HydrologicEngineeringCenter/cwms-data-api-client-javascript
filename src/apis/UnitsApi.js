...
exports.UnitsApiResponseProcessor = exports.UnitsApiRequestFactory = void 0;
 ...
 * no description
 */
var UnitsApiRequestFactory = /** @class */ (function (_super) {
    __extends(UnitsApiRequestFactory, _super);
    function UnitsApiRequestFactory() {
     ...
     */
    UnitsApiRequestFactory.prototype.getCwmsDataUnits = function (format, _options) {
    ...
    return UnitsApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.UnitsApiRequestFactory = UnitsApiRequestFactory;
var UnitsApiResponseProcessor = /** @class */ (function () {
    function UnitsApiResponseProcessor() {
    }
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getCwmsDataUnits
     * @throws ApiException if the response code was not in [200, 299]
     */
    UnitsApiResponseProcessor.prototype.getCwmsDataUnitsWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return UnitsApiResponseProcessor;
}());
exports.UnitsApiResponseProcessor = UnitsApiResponseProcessor;
