...
class LocationLevel {
     ...
     * @param officeId {String} Owning office of the level
     */
    constructor(locationLevelId, officeId) { 
        
        LocationLevel.initialize(this, locationLevelId, officeId);
    }
     ...
     */
    static initialize(obj, locationLevelId, officeId) { 
...
LocationLevel.RequiredProperties = ["location-level-id", "office-id"];
