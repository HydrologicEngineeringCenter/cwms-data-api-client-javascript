 ...
 */
TableRating.prototype['office-id'] = undefined;
/**
 * @member {String} rating-spec-id
 */
TableRating.prototype['rating-spec-id'] = undefined;
/**
 * @member {String} units-id
 */
TableRating.prototype['units-id'] = undefined;
/**
 * @member {Boolean} active
 */
TableRating.prototype['active'] = undefined;
/**
 * @member {Date} effective-date
 */
TableRating.prototype['effective-date'] = undefined;
/**
 * @member {Date} create-date
 */
TableRating.prototype['create-date'] = undefined;
/**
 * @member {Date} transition-date
 */
TableRating.prototype['transition-date'] = undefined;
/**
 * @member {String} description
 */
TableRating.prototype['description'] = undefined;
/**
 * @member {module:model/VerticalDatumInfo} vertical-datum-info
 */
TableRating.prototype['vertical-datum-info'] = undefined;
/**
 * @member {String} rating-type
 */
TableRating.prototype['rating-type'] = undefined;
/**
