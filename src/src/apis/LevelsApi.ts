...
export class LevelsApi extends runtime.BaseAPI {
     ...
     */
    async getCwmsDataLevelsWithLevelIdTimeseriesRaw(requestParameters: GetCwmsDataLevelsWithLevelIdTimeseriesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Timeseries>> {
        if (requestParameters['levelId'] == null) {
            throw new runtime.RequiredError(
                'levelId',
        ...
        if (requestParameters['office'] == null) {
            throw new runtime.RequiredError(
                'office',
                'Required parameter "office" was null or undefined when calling getCwmsDataLevelsWithLevelIdTimeseries().'
            );
        }
        ...
        if (requestParameters['unit'] == null) {
            throw new runtime.RequiredError(
                'unit',
                'Required parameter "unit" was null or undefined when calling getCwmsDataLevelsWithLevelIdTimeseries().'
            );
        }
     ...
     * Get cwmsData levels with levelId timeseries
     */
    async getCwmsDataLevelsWithLevelIdTimeseries(requestParameters: GetCwmsDataLevelsWithLevelIdTimeseriesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Timeseries> {
        const response = await this.getCwmsDataLevelsWithLevelIdTimeseriesRaw(requestParameters, initOverrides);
        return await response.value();
    }
