...
apiInstance.deleteCwmsDataLocationsWithLocationId(locationId, opts).then(() => {
...
apiInstance.getCwmsDataLocations(opts).then((data) => {
...
apiInstance.getCwmsDataLocationsWithLocationId(locationId, office, opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.patchCwmsDataLocationsWithLocationId(locationId, location).then(() => {
  console.log('API called successfully.');
}, (error) => {
  console.error(error);
});
...
let apiInstance = new cwmsjs.LocationsApi();
let location = new cwmsjs.Location(); // Location | 
apiInstance.postCwmsDataLocations(location).then(() => {
  console.log('API called successfully.');
}, (error) => {
  console.error(error);
});
