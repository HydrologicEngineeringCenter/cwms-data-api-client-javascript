...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new cwmsjs.TimeSeriesValuesInnerInner();
  });
  ...
  describe('TimeSeriesValuesInnerInner', function() {
    it('should create an instance of TimeSeriesValuesInnerInner', function() {
      ...
      //var instance = new cwmsjs.TimeSeriesValuesInnerInner();
      //expect(instance).to.be.a(cwmsjs.TimeSeriesValuesInnerInner);
    });
